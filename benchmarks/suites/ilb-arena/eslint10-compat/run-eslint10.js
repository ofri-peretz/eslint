...
/**
 * ESLint 10 Benchmark Runner
 *
 * Runs eslint-plugin-security, eslint-plugin-no-unsanitized, and eslint-plugin-import
 * in ESLint 10 (flat config) mode for fair comparison. Sibling of run-eslint8.js.
 */
...
const ESLINT_VERSION_LABEL = '10.x';
const RESULT_FILENAME_PREFIX = 'eslint10';

// NOTE: eslint-plugin-import is NOT in this matrix. As of 2026-05-09 the latest
// published version (2.32.0) declares peerDependencies.eslint = "^2 || ... || ^9"
// — it does not yet support ESLint 10. Re-add when upstream ships v10 support.
// This is itself a comparison data point: we run cleanly on v10, the de-facto
// standard import plugin does not.
