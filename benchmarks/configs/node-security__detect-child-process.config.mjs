...
//   npx eslint --config benchmarks/configs/node-security__detect-child-process.config.mjs --no-config-lookup <files>
...
export default [
  {
    ...
    rules: { 'node-security/detect-child-process': 'error' },
  },
];
