...
//   npx eslint --config benchmarks/configs/node-security__detect-non-literal-fs-filename.config.mjs --no-config-lookup <files>
import * as interlace from '/Users/ofri/repos/ofriperetz.dev/eslint-perfection/packages/eslint-plugin-node-security/dist/src/index.js';
...
export default [
  {
    ...
    plugins: { 'node-security': { rules: interlace.rules } },
    rules: { 'node-security/detect-non-literal-fs-filename': 'error' },
  },
];
