...
//   npx eslint --config benchmarks/configs/secure-coding__detect-non-literal-regexp.config.mjs --no-config-lookup <files>
...
export default [
  {
    ...
    rules: { 'secure-coding/detect-non-literal-regexp': 'error' },
  },
];
