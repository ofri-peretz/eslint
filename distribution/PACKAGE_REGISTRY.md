...
| **eslint-plugin-import-next**        | `2.3.0` | 61    | 3.1x faster eslint-plugin-import replacement                 | [📦](https://npmjs.com/package/eslint-plugin-import-next)        |
...
| Rule                         | Description                   |
| ---------------------------- | ----------------------------- |
| `no-cycle`                   | **8x faster** circular deps   |
