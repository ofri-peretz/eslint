...
| `eslint-plugin-conventions` | 6.0.5 | `conventions/` | — | `plugin-conventions` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-import-next` | 2.8.5 | `import-next/` | — | `plugin-import-next` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-node-security` | 5.6.4 | `node-security/` | — | `plugin-node-security` | security | `node` | ✅ | ✅ | ✅ |
