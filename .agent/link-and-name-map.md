...
| `eslint-plugin-conventions` | 6.0.1 | `conventions/` | — | `plugin-conventions` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-import-next` | 2.8.0 | `import-next/` | — | `plugin-import-next` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-node-security` | 5.6.0 | `node-security/` | — | `plugin-node-security` | security | `node` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-secure-coding` | 5.4.1 | `secure-coding/` | — | `plugin-secure-coding` | security | `—` | ✅ | ✅ | ✅ |
