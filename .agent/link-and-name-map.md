...
| `eslint-plugin-conventions` | 5.3.5 | `conventions/` | — | `plugin-conventions` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-maintainability` | 3.2.5 | `maintainability/` | — | `plugin-maintainability` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-reliability` | 4.1.6 | `reliability/` | — | `plugin-reliability` | quality | `—` | ✅ | ✅ | ✅ |
