...
| `eslint-plugin-conventions` | 5.3.4 | `conventions/` | — | `plugin-conventions` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-import-next` | 2.7.7 | `import-next/` | — | `plugin-import-next` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-maintainability` | 3.2.4 | `maintainability/` | — | `plugin-maintainability` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-operability` | 4.1.2 | `operability/` | — | `plugin-operability` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-reliability` | 4.1.5 | `reliability/` | — | `plugin-reliability` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-secure-coding` | 5.3.4 | `secure-coding/` | — | `plugin-secure-coding` | security | `—` | ✅ | ✅ | ✅ |
