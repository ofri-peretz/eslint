...
| `eslint-plugin-conventions` | 5.3.3 | `conventions/` | — | `plugin-conventions` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-import-next` | 2.7.6 | `import-next/` | — | `plugin-import-next` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-maintainability` | 3.2.3 | `maintainability/` | — | `plugin-maintainability` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-node-security` | 5.4.4 | `node-security/` | — | `plugin-node-security` | security | `node` | ✅ | ✅ | ✅ |
| `eslint-plugin-openai-security` | 0.3.4 | `openai-security/` | — | `plugin-openai-security` | security | `openai` | ✅ | ✅ | ✅ |
| `eslint-plugin-operability` | 4.1.1 | `operability/` | — | `plugin-operability` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-react-features` | 1.7.4 | `react-features/` | — | `plugin-react-features` | quality | `react` | ✅ | ✅ | ✅ |
| `eslint-plugin-reliability` | 4.1.4 | `reliability/` | — | `plugin-reliability` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-secure-coding` | 5.3.3 | `secure-coding/` | — | `plugin-secure-coding` | security | `—` | ✅ | ✅ | ✅ |
