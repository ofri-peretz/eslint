...
| `eslint-plugin-import-next` | 2.8.9 | `import-next/` | — | `plugin-import-next` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-node-security` | 5.6.7 | `node-security/` | — | `plugin-node-security` | security | `node` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-react-features` | 1.7.10 | `react-features/` | — | `plugin-react-features` | quality | `react` | ✅ | ✅ | ✅ |
| `eslint-plugin-reliability` | 4.1.12 | `reliability/` | — | `plugin-reliability` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-secure-coding` | 5.4.11 | `secure-coding/` | — | `plugin-secure-coding` | security | `—` | ✅ | ✅ | ✅ |
