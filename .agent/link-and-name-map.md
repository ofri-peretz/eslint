...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :-: | :-: | :-: |
| `eslint-plugin-anthropic-security` | 0.3.3 | `anthropic-security/` | — | `plugin-anthropic-security` | security | `claude` | ✅ | ✅ | ❌ |
| `eslint-plugin-browser-security` | 2.1.1 | `browser-security/` | — | `plugin-browser-security` | security | `chromium` | ✅ | ✅ | ✅ |
| `eslint-plugin-conventions` | 5.2.1 | `conventions/` | — | `plugin-conventions` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-drizzle-security` | 0.3.6 | `drizzle-security/` | — | `plugin-drizzle-security` | security | `drizzle` | ✅ | ✅ | ❌ |
| `eslint-plugin-express-security` | 3.2.1 | `express-security/` | — | `plugin-express-security` | security | `express` | ✅ | ✅ | ✅ |
| `eslint-plugin-gemini-security` | 0.3.4 | `gemini-security/` | — | `plugin-gemini-security` | security | `gemini` | ✅ | ✅ | ❌ |
| `eslint-plugin-import-next` | 2.7.1 | `import-next/` | — | `plugin-import-next` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-jwt-security` | 3.1.1 | `jwt-security/` | `jwt/` | `plugin-jwt-security` | security | `jwt` | ✅ | ✅ | ✅ |
| `eslint-plugin-knex-security` | 0.4.6 | `knex-security/` | — | `plugin-knex-security` | security | `knex` | ✅ | ✅ | ❌ |
| `eslint-plugin-lambda-security` | 2.1.1 | `lambda-security/` | — | `plugin-lambda-security` | security | `lambda` | ✅ | ✅ | ✅ |
| `eslint-plugin-maintainability` | 3.2.1 | `maintainability/` | — | `plugin-maintainability` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-mcp-sdk-security` | 0.4.1 | `mcp-sdk-security/` | — | `plugin-mcp-sdk-security` | security | `mcp` | ✅ | ✅ | ❌ |
| `eslint-plugin-modernization` | 3.1.1 | `modernization/` | — | `plugin-modernization` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-modularity` | 2.5.1 | `modularity/` | — | `plugin-modularity` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-mongodb-security` | 9.1.1 | `mongodb-security/` | — | `plugin-mongodb-security` | security | `mongodb` | ✅ | ✅ | ✅ |
| `eslint-plugin-mysql-security` | 0.3.6 | `mysql-security/` | — | `plugin-mysql-security` | security | `mysql` | ✅ | ✅ | ❌ |
| `eslint-plugin-nestjs-security` | 3.1.1 | `nestjs-security/` | — | `plugin-nestjs-security` | security | `nestjs` | ✅ | ✅ | ✅ |
| `eslint-plugin-node-security` | 5.3.1 | `node-security/` | — | `plugin-node-security` | security | `node` | ✅ | ✅ | ✅ |
| `eslint-plugin-openai-security` | 0.3.3 | `openai-security/` | — | `plugin-openai-security` | security | `openai` | ✅ | ✅ | ❌ |
| `eslint-plugin-operability` | 4.0.1 | `operability/` | — | `plugin-operability` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-postgresql-security` | 2.3.1 | `postgresql-security/` | `pg/` | `plugin-postgresql-security` | security | `postgresql` | ✅ | ✅ | ✅ |
| `eslint-plugin-prisma-security` | 0.3.6 | `prisma-security/` | — | `plugin-prisma-security` | security | `prisma` | ✅ | ✅ | ❌ |
| `eslint-plugin-react-a11y` | 2.5.1 | `react-a11y/` | — | `plugin-react-a11y` | quality | `react` | ✅ | ✅ | ✅ |
| `eslint-plugin-react-features` | 1.6.1 | `react-features/` | — | `plugin-react-features` | quality | `react` | ✅ | ✅ | ✅ |
| `eslint-plugin-reliability` | 4.1.1 | `reliability/` | — | `plugin-reliability` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-secure-coding` | 5.2.2 | `secure-coding/` | — | `plugin-secure-coding` | security | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-sequelize-security` | 0.3.7 | `sequelize-security/` | — | `plugin-sequelize-security` | security | `sequelize` | ✅ | ✅ | ❌ |
| `eslint-plugin-sqlite-security` | 0.1.9 | `sqlite-security/` | — | `plugin-sqlite-security` | security | `sqlite` | ✅ | ✅ | ❌ |
| `eslint-plugin-typeorm-security` | 0.3.6 | `typeorm-security/` | — | `plugin-typeorm-security` | security | `typeorm` | ✅ | ✅ | ❌ |
| `eslint-plugin-vercel-ai-security` | 2.1.1 | `vercel-ai-security/` | — | `plugin-vercel-ai-security` | security | `vercel` | ✅ | ✅ | ✅ |
