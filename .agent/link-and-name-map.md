...
| `eslint-plugin-browser-security` | 2.1.2 | `browser-security/` | — | `plugin-browser-security` | security | `chromium` | ✅ | ✅ | ✅ |
| `eslint-plugin-conventions` | 5.3.0 | `conventions/` | — | `plugin-conventions` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-drizzle-security` | 0.3.7 | `drizzle-security/` | — | `plugin-drizzle-security` | security | `drizzle` | ✅ | ✅ | ❌ |
| `eslint-plugin-express-security` | 3.2.2 | `express-security/` | — | `plugin-express-security` | security | `express` | ✅ | ✅ | ✅ |
| `eslint-plugin-gemini-security` | 0.3.4 | `gemini-security/` | — | `plugin-gemini-security` | security | `gemini` | ✅ | ✅ | ❌ |
| `eslint-plugin-import-next` | 2.7.2 | `import-next/` | — | `plugin-import-next` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-lambda-security` | 2.1.2 | `lambda-security/` | — | `plugin-lambda-security` | security | `lambda` | ✅ | ✅ | ✅ |
| `eslint-plugin-maintainability` | 3.2.2 | `maintainability/` | — | `plugin-maintainability` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-mcp-sdk-security` | 0.4.2 | `mcp-sdk-security/` | — | `plugin-mcp-sdk-security` | security | `mcp` | ✅ | ✅ | ❌ |
| `eslint-plugin-modernization` | 3.1.2 | `modernization/` | — | `plugin-modernization` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-modularity` | 2.5.2 | `modularity/` | — | `plugin-modularity` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-node-security` | 5.4.0 | `node-security/` | — | `plugin-node-security` | security | `node` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-postgresql-security` | 2.3.2 | `postgresql-security/` | `pg/` | `plugin-postgresql-security` | security | `postgresql` | ✅ | ✅ | ✅ |
| `eslint-plugin-prisma-security` | 0.3.7 | `prisma-security/` | — | `plugin-prisma-security` | security | `prisma` | ✅ | ✅ | ❌ |
| `eslint-plugin-react-a11y` | 2.5.1 | `react-a11y/` | — | `plugin-react-a11y` | quality | `react` | ✅ | ✅ | ✅ |
| `eslint-plugin-react-features` | 1.7.0 | `react-features/` | — | `plugin-react-features` | quality | `react` | ✅ | ✅ | ✅ |
| `eslint-plugin-reliability` | 4.1.2 | `reliability/` | — | `plugin-reliability` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-secure-coding` | 5.3.0 | `secure-coding/` | — | `plugin-secure-coding` | security | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-sequelize-security` | 0.3.8 | `sequelize-security/` | — | `plugin-sequelize-security` | security | `sequelize` | ✅ | ✅ | ❌ |
| `eslint-plugin-sqlite-security` | 0.1.10 | `sqlite-security/` | — | `plugin-sqlite-security` | security | `sqlite` | ✅ | ✅ | ❌ |
| `eslint-plugin-typeorm-security` | 0.3.7 | `typeorm-security/` | — | `plugin-typeorm-security` | security | `typeorm` | ✅ | ✅ | ❌ |
| `eslint-plugin-vercel-ai-security` | 2.1.2 | `vercel-ai-security/` | — | `plugin-vercel-ai-security` | security | `vercel` | ✅ | ✅ | ✅ |
