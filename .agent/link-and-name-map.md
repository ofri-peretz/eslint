...
| `eslint-plugin-conventions` | 6.0.0 | `conventions/` | — | `plugin-conventions` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-import-next` | 2.7.8 | `import-next/` | — | `plugin-import-next` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-maintainability` | 3.2.6 | `maintainability/` | — | `plugin-maintainability` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-node-security` | 5.5.0 | `node-security/` | — | `plugin-node-security` | security | `node` | ✅ | ✅ | ✅ |
| `eslint-plugin-openai-security` | 0.3.4 | `openai-security/` | — | `plugin-openai-security` | security | `openai` | ✅ | ✅ | ✅ |
| `eslint-plugin-operability` | 4.1.3 | `operability/` | — | `plugin-operability` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-reliability` | 4.1.7 | `reliability/` | — | `plugin-reliability` | quality | `—` | ✅ | ✅ | ✅ |
| `eslint-plugin-secure-coding` | 5.4.0 | `secure-coding/` | — | `plugin-secure-coding` | security | `—` | ✅ | ✅ | ✅ |
