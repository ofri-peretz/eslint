...
| `eslint-plugin-maintainability` | 3.2.11 | `maintainability/` | — | `plugin-maintainability` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-operability` | 4.1.5 | `operability/` | — | `plugin-operability` | quality | `—` | ✅ | ✅ | ✅ |
