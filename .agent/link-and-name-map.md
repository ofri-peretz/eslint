...
| `eslint-plugin-conventions` | 5.3.2 | `conventions/` | — | `plugin-conventions` | quality | `—` | ✅ | ✅ | ✅ |
...
| `eslint-plugin-react-features` | 1.7.3 | `react-features/` | — | `plugin-react-features` | quality | `react` | ✅ | ✅ | ✅ |
| `eslint-plugin-reliability` | 4.1.3 | `reliability/` | — | `plugin-reliability` | quality | `—` | ✅ | ✅ | ✅ |
