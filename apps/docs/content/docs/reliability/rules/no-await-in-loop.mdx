...
description: "Disallow await inside loops without considering concurrency implications. This rule is part of @eslint/eslint-plugin-architecture and provides LLM-optimized err"
---
