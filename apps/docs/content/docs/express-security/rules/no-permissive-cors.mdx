...
> **Keywords:** CORS, cross-origin resource sharing, [CWE-942](https://cwe.mitre.org/data/definitions/942.html), security, ESLint rule, origin validation, wildcard CORS, Access-Control-Allow-Origin, auto-fix, LLM-optimized
...
| Aspect            | Details                                          |
| ----------------- | ------------------------------------------------ |
| **CWE Reference** | [CWE-942](https://cwe.mitre.org/data/definitions/942.html) (Permissive Cross-domain Policy)         |
| **Severity**      | 🔴 High                                          |
...
```text
🔒 [CWE-942](https://cwe.mitre.org/data/definitions/942.html) OWASP:A01 CVSS:7.5 | CORS Misconfiguration detected | HIGH
