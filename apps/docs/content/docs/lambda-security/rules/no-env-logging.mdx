...
> **Keywords:** environment variables, logging, Lambda, [CWE-532](https://cwe.mitre.org/data/definitions/532.html), security, sensitive data exposure
...
| Aspect            | Details                                             |
| ----------------- | --------------------------------------------------- |
| **CWE Reference** | [CWE-532](https://cwe.mitre.org/data/definitions/532.html) (Insertion of Sensitive Info into Log File) |
| **Severity**      | 🟡 Warning                                          |
