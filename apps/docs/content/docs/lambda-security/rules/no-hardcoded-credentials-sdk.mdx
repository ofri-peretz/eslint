...
description: Detects hardcoded AWS credentials in SDK client configurations. This rule is part of eslint-plugin-lambda-security and provides LLM-optimized error messages.
---
