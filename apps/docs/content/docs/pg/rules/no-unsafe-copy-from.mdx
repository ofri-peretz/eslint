...
> **Keywords:** COPY FROM, file access, [CWE-73](https://cwe.mitre.org/data/definitions/73.html), pg, node-postgres, security, path injection
...
| Aspect            | Details                                 |
| ----------------- | --------------------------------------- |
| **CWE Reference** | [CWE-73](https://cwe.mitre.org/data/definitions/73.html) (External Control of File Name)  |
...
```
🔒 [CWE-73](https://cwe.mitre.org/data/definitions/73.html) OWASP:A03-Injection | Dynamic file path in COPY FROM detected - potential arbitrary file read. | CRITICAL [SOC2,PCI-DSS]
...
```
⚠️ [CWE-73](https://cwe.mitre.org/data/definitions/73.html) | Hardcoded file path in COPY FROM - server-side file access. | MEDIUM
...
- [OWASP [A03:2021](https://owasp.org/Top10/A03_2021-Injection/) Injection](https://owasp.org/Top10/A03_2021-Injection/)
