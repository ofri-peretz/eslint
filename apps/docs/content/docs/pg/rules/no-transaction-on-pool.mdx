...
> **Keywords:** transactions, race condition, [CWE-362](https://cwe.mitre.org/data/definitions/362.html), pg, node-postgres, pool
...
| Aspect            | Details                  |
| ----------------- | ------------------------ |
| **CWE Reference** | [CWE-362](https://cwe.mitre.org/data/definitions/362.html) (Race Condition) |
...
```
⚠️ [CWE-362](https://cwe.mitre.org/data/definitions/362.html) | Transaction command on pool causes race condition | HIGH
