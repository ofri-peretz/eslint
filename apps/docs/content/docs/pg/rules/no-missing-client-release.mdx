...
> **Keywords:** connection leak, resource management, [CWE-772](https://cwe.mitre.org/data/definitions/772.html), pg, node-postgres, pool
...
| Aspect            | Details                               |
| ----------------- | ------------------------------------- |
| **CWE Reference** | [CWE-772](https://cwe.mitre.org/data/definitions/772.html) (Missing Release of Resource) |
...
```
⚠️ [CWE-772](https://cwe.mitre.org/data/definitions/772.html) | Pool client acquired but never released | HIGH
