...
> **Keywords:** query parameters, [CWE-89](https://cwe.mitre.org/data/definitions/89.html), pg, node-postgres, quality, parameterized queries
...
| Aspect            | Details                           |
| ----------------- | --------------------------------- |
| **CWE Reference** | [CWE-89](https://cwe.mitre.org/data/definitions/89.html) (SQL Injection Prevention) |
...
```text
🔒 [CWE-89](https://cwe.mitre.org/data/definitions/89.html) OWASP:A05 CVSS:9.8 | SQL Injection detected | CRITICAL [SOC2,PCI-DSS,HIPAA,ISO27001]
