...
> **Keywords:** SSL, TLS, [CWE-295](https://cwe.mitre.org/data/definitions/295.html), pg, node-postgres, security, certificate validation
...
```
🔒 [CWE-295](https://cwe.mitre.org/data/definitions/295.html) | Insecure SSL: rejectUnauthorized: false disables certificate validation | HIGH
