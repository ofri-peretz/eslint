...
description: "CWE: [CWE-22](https://cwe.mitre.org/data/definitions/22.html)"
---

> **Keywords:** search_path, schema hijacking, [CWE-426](https://cwe.mitre.org/data/definitions/426.html), pg, node-postgres, security
...
| Aspect            | Details                         |
| ----------------- | ------------------------------- |
| **CWE Reference** | [CWE-426](https://cwe.mitre.org/data/definitions/426.html) (Untrusted Search Path) |
...
```text
🔒 [CWE-426](https://cwe.mitre.org/data/definitions/426.html) OWASP:A03 CVSS:7.5 | Untrusted Search Path detected | HIGH
