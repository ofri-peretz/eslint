...
> **Keywords:** unhandled promise, [CWE-252](https://cwe.mitre.org/data/definitions/252.html), pg, node-postgres, async
...
| Aspect            | Details                          |
| ----------------- | -------------------------------- |
| **CWE Reference** | [CWE-252](https://cwe.mitre.org/data/definitions/252.html) (Unchecked Return Value) |
...
```text
⚠️ [CWE-252](https://cwe.mitre.org/data/definitions/252.html) OWASP:A10 CVSS:5.3 | Unchecked Return Value detected | MEDIUM
