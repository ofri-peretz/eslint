...
> **Keywords:** double release, connection pool, [CWE-415](https://cwe.mitre.org/data/definitions/415.html), pg, node-postgres, pool corruption
...
| Aspect            | Details                   |
| ----------------- | ------------------------- |
| **CWE Reference** | [CWE-415](https://cwe.mitre.org/data/definitions/415.html) (Double Free)     |
