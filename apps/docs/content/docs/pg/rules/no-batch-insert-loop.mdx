...
> **Keywords:** N+1 queries, performance, [CWE-400](https://cwe.mitre.org/data/definitions/400.html), pg, node-postgres, bulk operations
...
| Aspect            | Details                       |
| ----------------- | ----------------------------- |
| **CWE Reference** | [CWE-400](https://cwe.mitre.org/data/definitions/400.html) (Resource Exhaustion) |
