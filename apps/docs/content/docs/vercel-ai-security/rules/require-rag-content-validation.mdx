...
description: "This rule identifies code patterns where content retrieved from vector stores or document retrieval systems is used directly in AI prompts without validation."
