...
description: Enforce domain-specific naming conventions with business context. This rule is part of @eslint/eslint-plugin-architecture and provides LLM-optimized error messa
category: quality
severity: low
tags: ['quality', 'modularity', 'architecture', 'naming']
autofix: suggestions
