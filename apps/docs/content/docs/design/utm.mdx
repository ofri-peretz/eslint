---
title: "UTM Philosophy"
description: "A focused sub-philosophy of URL_PHILOSOPHY.md (principle #5 \"default values never appear in URLs\" and principle #9 \"sticky parameters survive navigation\") an…"
icon: Tag
---
...
[ANALYTICS_PHILOSOPHY.md](/docs/design/analytics), covering how `utm_*`
