---
title: "Data Table Philosophy"
description: "A focused sub-philosophy of UX_PHILOSOPHY.md, expanding principle #1 (Adoption is friction subtraction), #5 (Discoverability beats memory), and #6 (Ease of u…"
icon: Table
---
...
A focused sub-philosophy of [UX_PHILOSOPHY.md](/docs/design/ux), expanding
...
Pairs with [PAGINATION_PHILOSOPHY.md](/docs/design/pagination) (we already
codified URL-state pagination) and [LOADING_PHILOSOPHY.md](/docs/design/loading)
...
query string per [DEEP_LINKING_PHILOSOPHY.md](/docs/design/deep-linking).
...
Cross-link to [PAGINATION_PHILOSOPHY.md](/docs/design/pagination). Tables
...
Cross-link to [LOADING_PHILOSOPHY.md](/docs/design/loading) and
[ERROR_PHILOSOPHY.md](/docs/design/error).
...
Cross-link to [A11Y_PHILOSOPHY.md](/docs/design/a11y).
