---
title: "CTA Philosophy"
description: "Every call-to-action on this site — hero buttons, final-CTA banners, README \"Install\" buttons, OG-card link previews, plugin-page \"Get started\" links — is go…"
...
This document is the sibling of [`UX_PHILOSOPHY.md`](/docs/design/ux) and
...
([`UX_PHILOSOPHY.md` #1](/docs/design/ux#1-adoption-is-friction-subtraction)).
A tie is a loss.
...
motion budget defined in [`MOTION_PHILOSOPHY.md`](/docs/design/motion).
...
([`UX_PHILOSOPHY.md` #9](/docs/design/ux#9-the-docs-site-is-the-showcase));
...
- Builds on [`UX_PHILOSOPHY.md` #11 (Build with the ecosystem)](/docs/design/ux#11-build-with-the-ecosystem-not-against-it):
...
- **Hover** changes fill or border, never geometry. A CTA that grows on
  hover causes layout shift ([`MOTION_PHILOSOPHY.md`](/docs/design/motion)
  CLS=0).
...
- **Loading** replaces the trailing icon with a spinner and locks the label
  ...
  [`LOADING_PHILOSOPHY.md`](/docs/design/loading) for the spinner pattern.)
