---
title: "Deep-Linking Philosophy"
description: "A focused sub-philosophy of URL_PHILOSOPHY.md and UX_PHILOSOPHY.md, expanding principle #2 (\"Every URL is a contract\") into the SPA + router surface."
icon: Link
---
{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: DEEP_LINKING_PHILOSOPHY.md
    hash: 3be92a5441a8 */}

A focused sub-philosophy of [URL_PHILOSOPHY.md](/docs/design/url) and
[UX_PHILOSOPHY.md](/docs/design/ux), expanding principle #2 ("Every URL is a
