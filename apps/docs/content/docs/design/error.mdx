---
title: "Error & Empty-State Philosophy"
description: "A focused sub-philosophy of UX_PHILOSOPHY.md, expanding principle #1 (Adoption is friction subtraction) into the failure path."
icon: AlertTriangle
---
{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: ERROR_PHILOSOPHY.md
    hash: 64615edf9069 */}
...
Pairs with [LOADING_PHILOSOPHY.md](/docs/design/loading): loading,
...
**Mechanics:** see [LOADING_PHILOSOPHY.md](/docs/design/loading) for the
skeleton contract.
...
**Cross-link:** [LAYOUT_PHILOSOPHY.md](/docs/design/layout) §6 *Reserve
