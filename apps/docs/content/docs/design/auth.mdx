---
title: "Auth Philosophy"
description: "A focused sub-philosophy of UX_PHILOSOPHY.md, expanding principle #1 (Adoption is friction subtraction) and #8 (Open the side door) into the authentication s…"
icon: Lock
---
...
Cross-link to [DEEP_LINKING_PHILOSOPHY.md](/docs/design/deep-linking) §1
...
Cross-link to [FORM_PHILOSOPHY.md](/docs/design/form) §3 and
[ERROR_PHILOSOPHY.md](/docs/design/error) §2. Auth errors are the most
...
Cross-link to [A11Y_PHILOSOPHY.md](/docs/design/a11y) §10. **No cognitive
