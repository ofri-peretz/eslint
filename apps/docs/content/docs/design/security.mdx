---
title: "Security-by-Design Philosophy (UI Surface)"
description: "A focused sub-philosophy of UX_PHILOSOPHY.md and INTEROP_PHILOSOPHY.md, expanding the security surface that lives in the UI layer."
icon: Shield
---
{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: SECURITY_PHILOSOPHY.md
    hash: f10709d689fa */}

A focused sub-philosophy of [UX_PHILOSOPHY.md](/docs/design/ux) and
[INTEROP_PHILOSOPHY.md](/docs/design/interop), expanding the security
...
Cross-link to [A11Y_PHILOSOPHY.md](/docs/design/a11y) §10 and
[AUTH_PHILOSOPHY.md](/docs/design/auth) §6. Bot defenses:
