---
title: "Keyboard Philosophy"
description: "Every page on this site must be fully operable with a keyboard alone — no mouse, no trackpad, no touch."
icon: Keyboard
---
...
This document is the sibling of [`UX_PHILOSOPHY.md`](/docs/design/ux),
[`CTA_PHILOSOPHY.md`](/docs/design/cta), and
[`MOTION_PHILOSOPHY.md`](/docs/design/motion) — principles ordered by
...
- [`UX_PHILOSOPHY.md`](/docs/design/ux) #1 (Adoption is friction
  subtraction) — keyboard nav IS friction subtraction for power users
  and accessibility users.
- [`UX_PHILOSOPHY.md`](/docs/design/ux) #6 (Ease of use is performance)
  — keyboard responsiveness IS performance for non-mouse users.
- [`CTA_PHILOSOPHY.md`](/docs/design/cta) #6 (Touch target ≥ 44×44) —
  applies to keyboard focus targets too.
- [`CTA_PHILOSOPHY.md`](/docs/design/cta) #10 (State is part of the
