...
description: "A focused sub-philosophy of UX_PHILOSOPHY.md, expanding principles #1 (Adoption is friction subtraction) and #6 (Ease of use is performance) into the data-en…"
icon: ClipboardList
---
{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: FORM_PHILOSOPHY.md
    hash: 0e80a7d4984a */}
...
This is a sibling of [LAYOUT_PHILOSOPHY.md](/docs/design/layout): layout is
