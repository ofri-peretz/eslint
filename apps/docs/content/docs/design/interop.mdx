---
title: "Tooling Interop & Static-Analysis Philosophy"
description: "A standalone engineering philosophy."
icon: Plug
---
...
A standalone engineering philosophy. Where [DOCS_PHILOSOPHY.md](/docs/design/docs)
governs what a rule looks like to a reader, and [URL_PHILOSOPHY.md](/docs/design/url)
