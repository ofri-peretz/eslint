---
title: "UX Philosophy"
description: "This is the foundational document for every UI/UX decision in this repo — the docs site, the @interlace/ui package, OG images, link metadata, the plugin READ…"
icon: Sparkles
---
{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: UX_PHILOSOPHY.md
    hash: 806f59a104f2 */}
