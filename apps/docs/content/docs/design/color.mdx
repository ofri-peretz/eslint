---
title: "Color & Theming Philosophy"
description: "A focused sub-philosophy of UX_PHILOSOPHY.md, paired with TYPOGRAPHY_PHILOSOPHY.md — together they define the page's visual contract."
icon: Palette
---
...
paired with [TYPOGRAPHY_PHILOSOPHY.md](/docs/design/typography) —
