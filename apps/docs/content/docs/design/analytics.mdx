...
description: "A focused sub-philosophy of DEEP_LINKING_PHILOSOPHY.md and UTM_PHILOSOPHY.md, covering how a deployed surface measures itself — what events get captured, how…"
icon: BarChart3
---
{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: ANALYTICS_PHILOSOPHY.md
    hash: 104f4338013c */}

A focused sub-philosophy of [DEEP_LINKING_PHILOSOPHY.md](/docs/design/deep-linking)
and [UTM_PHILOSOPHY.md](/docs/design/utm), covering how a deployed surface
