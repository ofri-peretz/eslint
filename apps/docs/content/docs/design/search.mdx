...
description: "A focused sub-philosophy of UX_PHILOSOPHY.md, expanding Principle #1 (friction subtraction) and Principle #5 (discoverability beats memory)."
icon: Search
---
{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: SEARCH_PHILOSOPHY.md
    hash: 157c41244d58 */}
