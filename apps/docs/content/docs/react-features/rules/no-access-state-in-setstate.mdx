...
description: Disallows accessing this.state inside setState calls to prevent race conditions. This rule is part of @eslint/eslint-plugin-react-features and provides LLM-opti
category: quality
severity: low
tags: ['quality', 'react']
autofix: suggestions
