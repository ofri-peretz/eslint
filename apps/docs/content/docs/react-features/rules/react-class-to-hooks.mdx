...
description: Suggest migrating React class components to hooks with detailed migration path. This rule is part of @eslint/eslint-plugin-react-features and provides LLM-optim
category: quality
severity: low
tags: ['quality', 'react']
autofix: suggestions
