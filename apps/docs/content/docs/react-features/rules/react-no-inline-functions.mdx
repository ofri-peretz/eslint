...
description: "Prevent inline functions in React renders with performance metrics. This rule is part of @eslint/eslint-plugin-react-features and provides LLM-optimized error m"
---
