...
description: "Enforce required attributes on React components with customizable ignore lists. This rule is part of @eslint/eslint-plugin-react-features and provides LLM-optim"
---
