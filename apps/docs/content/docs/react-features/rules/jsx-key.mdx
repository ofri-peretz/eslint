---
title: jsx-key
description: 'Detect missing or problematic React keys that could break reconciliation. This rule is part of @eslint/eslint-plugin-react-features and provides LLM-optimized e'
---
...
| Compound unique | ✅ Good  | `key={category + "-" + name}` |
