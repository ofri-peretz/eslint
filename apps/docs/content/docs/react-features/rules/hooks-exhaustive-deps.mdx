...
description: "Enforce exhaustive dependencies in React hooks to prevent stale closures. This rule is part of @eslint/eslint-plugin-react-features and provides LLM-optimized e"
---
