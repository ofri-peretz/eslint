---
title: jsx-max-depth
description: "Limits the maximum depth of JSX nesting to encourage component extraction and improve readability. This rule is part of @eslint/eslint-plugin-react-features and"
---
