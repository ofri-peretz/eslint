---
title: no-danger
description: "Disallow dangerouslySetInnerHTML usage to prevent XSS vulnerabilities. This rule is part of @eslint/eslint-plugin-react-features and provides LLM-optimized erro"
---
...
| **CWE Reference**    | ✅ [CWE-79](https://cwe.mitre.org/data/definitions/79.html)           | ❌ No               | ❌ No              |
