...
description: Prevents string literals directly in JSX to encourage internationalization and consistent text management. This rule is part of @eslint/eslint-plugin-react-feat
category: quality
severity: low
tags: ['quality', 'react']
autofix: suggestions
