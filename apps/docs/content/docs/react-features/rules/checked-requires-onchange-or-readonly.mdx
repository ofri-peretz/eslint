...
description: Ensures controlled inputs with checked or value props have an onChange handler or readOnly attribute. This rule is part of @eslint/eslint-plugin-react-features
category: quality
severity: low
tags: ['quality', 'react']
autofix: suggestions
