---
title: display-name
description: "Enforce component display names for better debugging experience. This rule is part of @eslint/eslint-plugin-react-features and provides LLM-optimized error mess"
---
