...
> **Keywords:** privilege escalation, [CWE-269](https://cwe.mitre.org/data/definitions/269.html), security, ESLint rule, role assignment, permission bypass, access control, user input, role checks, LLM-optimized, code security
...
| Aspect            | Details                                                                  |
| ----------------- | ------------------------------------------------------------------------ |
| **CWE Reference** | [CWE-269](https://cwe.mitre.org/data/definitions/269.html) (Improper Privilege Management)                                  |
...
```text
🔒 [CWE-269](https://cwe.mitre.org/data/definitions/269.html) OWASP:A01 CVSS:8.8 | Improper Privilege Management detected | HIGH [SOC2,PCI-DSS,HIPAA,GDPR,ISO27001]
