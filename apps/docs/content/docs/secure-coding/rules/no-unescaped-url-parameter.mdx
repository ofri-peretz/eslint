...
description: "CWE: [CWE-116](https://cwe.mitre.org/data/definitions/116.html)"
---

> **Keywords:** URL encoding, [CWE-79](https://cwe.mitre.org/data/definitions/79.html), security, ESLint rule, URL parameters, encodeURIComponent, URLSearchParams, XSS, open redirect, auto-fix, LLM-optimized, code security
...
```text
⚠️ [CWE-79](https://cwe.mitre.org/data/definitions/79.html) OWASP:A05 CVSS:6.1 | Cross-site Scripting (XSS) detected | MEDIUM [SOC2,PCI-DSS,GDPR,ISO27001]
