...
description: "CWE: [CWE-798](https://cwe.mitre.org/data/definitions/798.html)"
---

> **Keywords:** no weak password recovery, security, ESLint rule, JavaScript, TypeScript, [CWE-640](https://cwe.mitre.org/data/definitions/640.html), [CWE-620](https://cwe.mitre.org/data/definitions/620.html), authentication, ATO, tokens
...
| --------------- | ------------------------------ | ------------------------ |
| 🔒 **Security** | Account Takeover ([CWE-640](https://cwe.mitre.org/data/definitions/640.html))     | Use CSPRNG for tokens    |
...
```
🔒 [CWE-640](https://cwe.mitre.org/data/definitions/640.html) OWASP:A07-Auth CVSS:9.8 | Weak Password Recovery | CRITICAL [SOC2,PCI-DSS,HIPAA]
