...
> **Keywords:** GraphQL injection, [CWE-943](https://cwe.mitre.org/data/definitions/943.html), [CWE-400](https://cwe.mitre.org/data/definitions/400.html), security, DoS, introspection, query complexity, LLM-optimized
...
```
🔒 [CWE-943](https://cwe.mitre.org/data/definitions/943.html) OWASP:A03-Injection CVSS:8.6 | GraphQL Injection detected | CRITICAL [SOC2,PCI-DSS]
