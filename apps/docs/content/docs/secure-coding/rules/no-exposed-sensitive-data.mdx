...
> **Keywords:** sensitive data, [CWE-200](https://cwe.mitre.org/data/definitions/200.html), security, ESLint rule, PII, SSN, credit card, password, API key, data exposure, logging, LLM-optimized, code security
...
> **Keywords:** no exposed sensitive data, security, ESLint rule, JavaScript, TypeScript, [CWE-532](https://cwe.mitre.org/data/definitions/532.html), [CWE-200](https://cwe.mitre.org/data/definitions/200.html), PII, secrets, logging
...
flowchart TD
    ...
    Attacker -->|Read Logs| Leak[🔓 Data Leak [CWE-53](https://cwe.mitre.org/data/definitions/53.html)2]
...
| ----------------- | -------------------------------- | ----------------------------------- |
| 🔒 **Security**   | Data breaches via logs ([CWE-532](https://cwe.mitre.org/data/definitions/532.html)) | Redact sensitive fields/objects     |
