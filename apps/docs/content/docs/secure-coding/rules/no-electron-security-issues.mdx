...
> **Keywords:** Electron, [CWE-16](https://cwe.mitre.org/data/definitions/16.html), nodeIntegration, contextIsolation, desktop security
...
```text
⚠️ [CWE-16](https://cwe.mitre.org/data/definitions/16.html) OWASP:A02 CVSS:5.3 | Configuration detected | MEDIUM
