...
> **Keywords:** CORS, cross-origin resource sharing, [CWE-346](https://cwe.mitre.org/data/definitions/346.html), security, ESLint rule, origin validation, wildcard CORS, Access-Control-Allow-Origin, auto-fix, LLM-optimized, code security
