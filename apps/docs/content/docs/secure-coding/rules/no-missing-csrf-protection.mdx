...
description: "CWE: [CWE-352](https://cwe.mitre.org/data/definitions/352.html)"
---

> **Keywords:** CSRF, [CWE-352](https://cwe.mitre.org/data/definitions/352.html), security, ESLint rule, CSRF protection, token validation, middleware, Express, Fastify, LLM-optimized, code security
...
| Aspect            | Details                                                               |
| ----------------- | --------------------------------------------------------------------- |
| **CWE Reference** | [CWE-352](https://cwe.mitre.org/data/definitions/352.html) (Cross-Site Request Forgery)                                  |
...
```text
🔒 [CWE-352](https://cwe.mitre.org/data/definitions/352.html) OWASP:A01 CVSS:8.8 | Cross-Site Request Forgery (CSRF) detected | HIGH
