...
> **Keywords:** unencrypted, [CWE-319](https://cwe.mitre.org/data/definitions/319.html), security, ESLint rule, HTTP, HTTPS, encryption, TLS, SSL, data transmission, LLM-optimized, code security
