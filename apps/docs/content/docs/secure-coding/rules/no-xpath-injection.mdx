...
> **Keywords:** XPath injection, [CWE-643](https://cwe.mitre.org/data/definitions/643.html), XML, security, data extraction, authentication bypass
...
```
🔒 [CWE-643](https://cwe.mitre.org/data/definitions/643.html) OWASP:A03-Injection CVSS:9.8 | XPath Injection detected | CRITICAL [SOC2,PCI-DSS]
