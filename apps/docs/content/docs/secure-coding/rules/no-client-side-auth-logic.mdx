...
> **Keywords:** client-side auth, [CWE-602](https://cwe.mitre.org/data/definitions/602.html), localStorage auth, security bypass, authentication, JavaScript security
...
```text
⚠️ [CWE-602](https://cwe.mitre.org/data/definitions/602.html) OWASP:A06 CVSS:6.5 | Client-Side Enforcement of Server-Side Security detected | MEDIUM
