...
> **Keywords:** no unsafe regex construction, security, ESLint rule, JavaScript, TypeScript, [CWE-400](https://cwe.mitre.org/data/definitions/400.html), [CWE-185](https://cwe.mitre.org/data/definitions/185.html), ReDoS, injection
