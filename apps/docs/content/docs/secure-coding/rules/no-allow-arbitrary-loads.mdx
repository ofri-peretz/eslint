...
> **Keywords:** ATS, App Transport Security, iOS security, [CWE-295](https://cwe.mitre.org/data/definitions/295.html), NSAppTransportSecurity, allowArbitraryLoads, mobile security
...
```
🔒 [CWE-295](https://cwe.mitre.org/data/definitions/295.html) | Prevent configuration allowing insecure loads detected - allowArbitraryLoads: true | HIGH
