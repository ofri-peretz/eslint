...
description: Disallows dynamic require() calls with non-literal arguments that could lead to security vulnerabilities. This rule is part of eslint-plugin-secure-coding and p
---
