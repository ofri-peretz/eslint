...
> **Keywords:** XXE, XML External Entity, [CWE-611](https://cwe.mitre.org/data/definitions/611.html), SSRF, file disclosure, security, XML parsing
...
```text
🔒 [CWE-611](https://cwe.mitre.org/data/definitions/611.html) OWASP:A05 CVSS:9.1 | XXE (XML External Entity) detected | CRITICAL
