...
> **Keywords:** unsafe deserialization, [CWE-502](https://cwe.mitre.org/data/definitions/502.html), RCE, code execution, YAML, pickle, security
...
```text
🔒 [CWE-502](https://cwe.mitre.org/data/definitions/502.html) OWASP:A08 CVSS:9.8 | Deserialization of Untrusted Data detected | CRITICAL
