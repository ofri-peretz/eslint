...
> **Keywords:** insecure comparison, [CWE-697](https://cwe.mitre.org/data/definitions/697.html), security, ESLint rule, loose equality, type coercion, == vs ===, strict equality, JavaScript security, auto-fix, LLM-optimized, code security
...
| Aspect            | Details                                                                    |
| ----------------- | -------------------------------------------------------------------------- |
| **CWE Reference** | [CWE-697](https://cwe.mitre.org/data/definitions/697.html) (Incorrect Comparison)                                             |
...
```text
⚠️ [CWE-697](https://cwe.mitre.org/data/definitions/697.html) OWASP:A06 CVSS:5.3 | Incorrect Comparison detected | MEDIUM
