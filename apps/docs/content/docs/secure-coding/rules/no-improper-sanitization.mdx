...
> **Keywords:** improper sanitization, [CWE-116](https://cwe.mitre.org/data/definitions/116.html), [CWE-79](https://cwe.mitre.org/data/definitions/79.html), XSS, encoding, escaping, security
...
```
🔒 [CWE-116](https://cwe.mitre.org/data/definitions/116.html) OWASP:A03-Injection CVSS:7.5 | Improper Sanitization | HIGH [SOC2,PCI-DSS]
