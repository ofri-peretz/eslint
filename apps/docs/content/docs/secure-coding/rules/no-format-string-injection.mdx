...
> **Keywords:** format string injection, [CWE-134](https://cwe.mitre.org/data/definitions/134.html), printf, util.format, logging, security
...
```
🔒 [CWE-134](https://cwe.mitre.org/data/definitions/134.html) OWASP:A03-Injection CVSS:9.8 | Format String Injection | CRITICAL [SOC2,PCI-DSS]
