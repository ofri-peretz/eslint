...
> **Keywords:** LDAP injection, [CWE-90](https://cwe.mitre.org/data/definitions/90.html), directory service, authentication bypass, security, Active Directory
...
```text
🔒 [CWE-90](https://cwe.mitre.org/data/definitions/90.html) OWASP:A05 CVSS:9.8 | LDAP Injection detected | CRITICAL
