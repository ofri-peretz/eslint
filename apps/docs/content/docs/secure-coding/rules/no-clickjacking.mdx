...
> **Keywords:** clickjacking, [CWE-1021](https://cwe.mitre.org/data/definitions/1021.html), iframe, X-Frame-Options, CSP, UI redressing
...
```
🔒 [CWE-1021](https://cwe.mitre.org/data/definitions/1021.html) OWASP:A05-Misconfig CVSS:6.1 | Clickjacking Vulnerability | MEDIUM [SOC2,PCI-DSS]
