...
> **Keywords:** unchecked loop, [CWE-400](https://cwe.mitre.org/data/definitions/400.html), [CWE-835](https://cwe.mitre.org/data/definitions/835.html), infinite loop, DoS, security
...
| Aspect            | Details                                                              |
| ----------------- | -------------------------------------------------------------------- |
| **CWE Reference** | [CWE-400](https://cwe.mitre.org/data/definitions/400.html) (Uncontrolled Resource Consumption), [CWE-835](https://cwe.mitre.org/data/definitions/835.html) (Infinite Loop) |
...
```text
🔒 [CWE-400](https://cwe.mitre.org/data/definitions/400.html) OWASP:A06 CVSS:7.5 | Uncontrolled Resource Consumption (ReDoS) detected | HIGH
