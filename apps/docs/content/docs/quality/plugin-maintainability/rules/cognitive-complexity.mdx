...
- [`identical-functions`](./identical-functions) - Detects duplicate code
- [`no-circular-dependencies`](./no-circular-dependencies) - Prevents circular imports
- [`no-internal-modules`](./no-internal-modules) - Enforces module boundaries
