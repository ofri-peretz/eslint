...
- [`no-external-api-calls-in-utils`](./no-external-api-calls-in-utils) - Keep utility modules side-effect free
- [`enforce-naming`](./enforce-naming) - Consistent naming across module boundaries
