...
- [`no-unsafe-type-narrowing`](./no-unsafe-type-narrowing) - General type safety patterns
- [`require-array-type-guards`](./require-array-type-guards) - Ensuring reliable type checks
