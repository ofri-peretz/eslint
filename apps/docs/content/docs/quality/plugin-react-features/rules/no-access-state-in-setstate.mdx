...
- [`no-set-state`](./no-set-state) - Discourage setState usage
- [`no-did-mount-set-state`](./no-did-mount-set-state) - No setState in componentDidMount
- [`no-did-update-set-state`](./no-did-update-set-state) - No setState in componentDidUpdate
