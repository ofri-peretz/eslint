...
- [`sort-comp`](./sort-comp) - Method ordering
- [`no-did-mount-set-state`](./no-did-mount-set-state) - State initialization timing
- [`react-class-to-hooks`](./react-class-to-hooks) - Migration to hooks
