...
- [`react-render-optimization`](./react-render-optimization) - Render patterns
- [`no-unnecessary-rerenders`](./no-unnecessary-rerenders) - Re-render prevention
- [`react-no-inline-functions`](./react-no-inline-functions) - Inline function detection
