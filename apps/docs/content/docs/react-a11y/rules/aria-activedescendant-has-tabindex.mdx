...
description: Require tabindex with aria-activedescendant. This rule is part of eslint-plugin-react-a11y and provides LLM-optimized error messages with fix suggestions.
category: quality
severity: low
