...
description: Require required ARIA properties for roles. This rule is part of eslint-plugin-react-a11y and provides LLM-optimized error messages with fix suggestions.
---
