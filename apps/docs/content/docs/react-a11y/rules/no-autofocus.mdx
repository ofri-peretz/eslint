---
title: no-autofocus
description: Prevent autofocus attribute usage. This rule is part of eslint-plugin-react-a11y and provides LLM-optimized error messages with fix suggestions.
---
