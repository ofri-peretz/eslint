...
description: Require ARIA labels on interactive elements. This rule is part of eslint-plugin-react-a11y and provides LLM-optimized error messages with fix suggestions.
---
