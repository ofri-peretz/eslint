...
description: Require title on iframe elements. This rule is part of eslint-plugin-react-a11y and provides LLM-optimized error messages with fix suggestions.
category: quality
severity: low
