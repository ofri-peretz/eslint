...
<Callout type="tip" title="Explore AST Interactively">
  The best way to understand AST is to experiment with real code. Use the tools
  below to visualize how ESLint parses your JavaScript.
</Callout>

**Recommended tools:**

- [AST Explorer](https://astexplorer.net/) — The gold standard for AST visualization. Select `@babel/eslint-parser` to see exactly what ESLint sees.
- [ESLint Playground](https://eslint.org/play/) — Test rules against code in real-time
