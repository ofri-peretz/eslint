...
| :--- | ---: | :--- |
| `secure-coding` | 27 | Sits alongside `eslint-plugin-security` (~3.1M weekly, generic) and `eslint-plugin-no-secrets`. We extend with CWE / CVSS metadata + MCP integration. |
