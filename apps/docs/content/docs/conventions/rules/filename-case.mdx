---
title: filename-case
description: Enforce filename case conventions for consistency across your codebase. This rule is part of @eslint/eslint-plugin-architecture and provides LLM-optimized error
category: quality
severity: low
