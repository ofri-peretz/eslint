...
- [`no-exposed-error-details`](./no-exposed-error-details) - Don't expose error details to users
- [`require-timeout-handling`](./require-timeout-handling) - Handle timeout errors
