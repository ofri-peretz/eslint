...
<RemoteReadme plugin="react-a11y" />
...
<Cards>
  <Card
    ...
    href="/docs/security/plugin-react-a11y/changelog"
  ...
  <Card
    title="Rules"
    description="Browse all 36 available rules"
    href="/docs/security/plugin-react-a11y/rules"
