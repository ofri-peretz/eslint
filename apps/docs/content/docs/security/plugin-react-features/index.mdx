...
<RemoteReadme plugin="react-features" />
...
<Cards>
  <Card
    ...
    href="/docs/security/plugin-react-features/changelog"
  ...
  <Card
    title="Rules"
    description="Browse all 51 available rules"
    href="/docs/security/plugin-react-features/rules"
