...
- [`no-cryptojs-weak-random`](./no-cryptojs-weak-random) - Specific CVE-2020-36732 detection
- [`prefer-native-crypto`](./prefer-native-crypto) - Prefer native crypto over all third-party libs
