...
- [`require-dependency-integrity`](./require-dependency-integrity) - SRI for CDN resources
- [`lock-file`](./lock-file) - Enforce lock files
- [`detect-suspicious-dependencies`](./detect-suspicious-dependencies) - Dependency confusion
