...
- [`no-static-iv`](./no-static-iv) - Detect hardcoded IVs
- [`no-weak-cipher-algorithm`](./no-weak-cipher-algorithm) - Detect weak ciphers
- [`no-insecure-key-derivation`](./no-insecure-key-derivation) - Detect weak key derivation
