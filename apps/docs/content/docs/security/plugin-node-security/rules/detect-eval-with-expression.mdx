...
- [`detect-child-process`](./detect-child-process) - Prevents command injection
- [`detect-non-literal-fs-filename`](./detect-non-literal-fs-filename) - Prevents path traversal
- [`detect-object-injection`](./detect-object-injection) - Prevents prototype pollution
- [`detect-non-literal-regexp`](./detect-non-literal-regexp) - Prevents ReDoS attacks
