...
- [`no-unbounded-decompression`](./no-unbounded-decompression) — Detect decompression with no output limit
- [`detect-non-literal-fs-filename`](./detect-non-literal-fs-filename) — Detect attacker-steerable filesystem paths
