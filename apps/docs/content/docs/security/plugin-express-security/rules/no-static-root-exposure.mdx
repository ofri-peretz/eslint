...
- [`no-exposed-debug-endpoints`](./no-exposed-debug-endpoints) - Debug surfaces left reachable
- [`require-helmet`](./require-helmet) - Security headers
- [`no-user-controlled-render-locals`](./no-user-controlled-render-locals) - Template object injection
