...
- [`no-unvalidated-user-input`](./no-unvalidated-user-input) - Detects unvalidated user input
- [`no-unsanitized-html`](./no-unsanitized-html) - Detects unsanitized HTML injection
- [`no-sql-injection`](./no-sql-injection) - Detects SQL injection vulnerabilities
- [`no-missing-cors-check`](./no-missing-cors-check) - Detects missing CORS validation
