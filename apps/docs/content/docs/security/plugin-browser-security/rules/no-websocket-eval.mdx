...
- [`browser-security/no-eval`](./no-eval) - General eval() prevention
- [`browser-security/no-websocket-innerhtml`](./no-websocket-innerhtml) - XSS prevention
- [`browser-security/require-websocket-wss`](./require-websocket-wss) - Require encrypted connections
