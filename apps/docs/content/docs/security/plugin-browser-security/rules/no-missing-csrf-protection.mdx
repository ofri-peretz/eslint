...
- [`no-insecure-cookie-settings`](./no-insecure-cookie-settings) - Detects insecure cookie configurations
- [`no-missing-authentication`](./no-missing-authentication) - Detects missing authentication
