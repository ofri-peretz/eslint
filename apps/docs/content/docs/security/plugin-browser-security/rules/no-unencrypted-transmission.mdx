...
- [`no-exposed-sensitive-data`](./no-exposed-sensitive-data) - Detects sensitive data exposure
- [`no-insecure-cookie-settings`](./no-insecure-cookie-settings) - Detects insecure cookies
