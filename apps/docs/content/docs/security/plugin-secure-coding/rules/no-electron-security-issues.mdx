...
- [`no-insufficient-postmessage-validation`](./no-insufficient-postmessage-validation) - postMessage validation
- [`detect-eval-with-expression`](./detect-eval-with-expression) - Code injection