...
- [`no-hardcoded-credentials`](./no-hardcoded-credentials) - Detect hardcoded passwords
- [`require-secure-credential-storage`](./require-secure-credential-storage) - Secure storage
