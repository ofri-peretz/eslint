...
- [`require-tool-confirmation`](./require-tool-confirmation) - Require confirmation for destructive tools
- [`require-output-filtering`](./require-output-filtering) - Filter tool output
