...
- [`no-sensitive-in-prompt`](./no-sensitive-in-prompt) - Prevent sensitive data in prompts
- [`no-dynamic-system-prompt`](./no-dynamic-system-prompt) - Prevent dynamic system prompts
