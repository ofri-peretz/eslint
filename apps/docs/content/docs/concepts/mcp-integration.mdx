...
```
🚨 [CRITICAL] XSS via innerHTML ([CWE-79](https://cwe.mitre.org/data/definitions/79.html))
...
| **CWE ID** | Standardized vulnerability type | [CWE-79](https://cwe.mitre.org/data/definitions/79.html) (XSS) |
...
<Steps>
  ...
  <Step>
    ...
    ```json
    {
      ...
      "message": "🚨 [CRITICAL] SQL Injection ([CWE-89](https://cwe.mitre.org/data/definitions/89.html))\n└─ Fix: Use parameterized queries: db.query('SELECT...', [id])",
      "severity": 2,
      "line": 2
    }
    ```
