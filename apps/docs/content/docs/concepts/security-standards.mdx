...
<div className="grid sm:grid-cols-2 gap-4 my-6">
  <div className="p-4 rounded-lg border border-fd-border bg-fd-card">
    ...
    <ul className="text-sm text-fd-muted-foreground space-y-1">
      ...
      <li> Hierarchical ([CWE-74](https://cwe.mitre.org/data/definitions/74.html) → [CWE-89](https://cwe.mitre.org/data/definitions/89.html))</li>
  ...
  <div className="p-4 rounded-lg border border-fd-border bg-fd-card">
    ...
    <ul className="text-sm text-fd-muted-foreground space-y-1">
      <li> **[CWE-79](https://cwe.mitre.org/data/definitions/79.html)**: Cross-site Scripting (XSS)</li>
      <li> **[CWE-89](https://cwe.mitre.org/data/definitions/89.html)**: SQL Injection</li>
      <li> **[CWE-22](https://cwe.mitre.org/data/definitions/22.html)**: Path Traversal</li>
      <li> **[CWE-798](https://cwe.mitre.org/data/definitions/798.html)**: Hardcoded Credentials</li>
    </ul>
  </div>
</div>
...
// CWE: [CWE-89](https://cwe.mitre.org/data/definitions/89.html) (Improper Neutralization of Special Elements in SQL Command)
...
<div className="grid sm:grid-cols-3 gap-4 my-6">
  <div className="p-4 rounded-lg border border-fd-border bg-violet-500/5">
    ...
    <span className="text-sm text-fd-muted-foreground">
      ...
      <br />
      e.g., [A03:2021](https://owasp.org/Top10/A03_2021-Injection/) Injection
    </span>
  </div>
...
curl "https://services.nvd.nist.gov/rest/json/cves/2.0?cweId=[CWE-89](https://cwe.mitre.org/data/definitions/89.html)"
...
- **SQL Injection ([CWE-89](https://cwe.mitre.org/data/definitions/89.html))**: 9.8 — arbitrary database queries can lead to complete data breach
- **Hardcoded Secrets ([CWE-798](https://cwe.mitre.org/data/definitions/798.html))**: 9.8 — exposed credentials enable direct system access
- **Missing Auth Check ([CWE-862](https://cwe.mitre.org/data/definitions/862.html))**: 7.5 — unauthorized access to protected resources
