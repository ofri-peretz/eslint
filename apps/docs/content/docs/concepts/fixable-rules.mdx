...
```
error 🔒 [CWE-89](https://cwe.mitre.org/data/definitions/89.html) OWASP:A03 CVSS:9.8 | SQL Injection | CRITICAL
...
<Steps>
  ...
  <Step>
    ...
    The LLM reads the error message, understands it's a [CWE-89](https://cwe.mitre.org/data/definitions/89.html) SQL Injection with CVSS 9.8.
  </Step>
  <Step>
    ### AI Proposes Fix
