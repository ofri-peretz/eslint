...
- **[ESLint Architecture](https://eslint.org/docs/latest/extend/architecture)** - How ESLint rule traversal works
- **[SAST vs DAST](https://owasp.org/www-community/Vulnerability_Scanning_Tools)** - When to use which approach
