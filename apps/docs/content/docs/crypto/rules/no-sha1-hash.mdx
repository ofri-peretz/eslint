---
title: no-sha1-hash
description: Disallow the use of the SHA-1 hashing algorithm specifically from the crypto-hash library.
---
...
```text
🔒 [CWE-327](https://cwe.mitre.org/data/definitions/327.html) OWASP:A04 CVSS:7.5 | Broken Cryptographic Algorithm detected | CRITICAL [PCI-DSS,HIPAA,ISO27001,NIST-CSF]
