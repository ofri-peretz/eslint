...
description: Disallow hardcoded cryptographic keys in crypto.createCipheriv() and crypto.createDecipheriv().
---
...
```text
🔒 [CWE-321](https://cwe.mitre.org/data/definitions/321.html) OWASP:A04 CVSS:9.1 | Hardcoded Cryptographic Key detected | CRITICAL [SOC2,PCI-DSS,HIPAA,GDPR,ISO27001,NIST-CSF]
