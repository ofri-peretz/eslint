...
description: Disallow the use of the weak PRNG in crypto-js.
---
...
```text
🔒 [CWE-338](https://cwe.mitre.org/data/definitions/338.html) OWASP:A04 CVSS:9.1 | Weak PRNG detected | CRITICAL [PCI-DSS,HIPAA,ISO27001,NIST-CSF]
