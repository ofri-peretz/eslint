...
description: "Require @UseGuards decorator on controllers or route handlers"
---
...
```text
🔒 [CWE-284](https://cwe.mitre.org/data/definitions/284.html) OWASP:A01 CVSS:7.5 | Improper Access Control detected | HIGH
...
- **OWASP Top 10 2021**: [A01:2021](https://owasp.org/Top10/A01_2021-Broken_Access_Control/) - Broken Access Control
