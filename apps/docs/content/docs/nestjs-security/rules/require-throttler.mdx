...
description: "Require ThrottlerGuard or @Throttle decorator for rate limiting"
---
...
- **OWASP Top 10 2021**: [A05:2021](https://owasp.org/Top10/A05_2021-Security_Misconfiguration/) - Security Misconfiguration
