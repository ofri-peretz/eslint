...
> **Keywords:** command injection, [CWE-78](https://cwe.mitre.org/data/definitions/78.html), security, ESLint rule, child_process, exec, spawn, OS command injection, shell injection, auto-fix, LLM-optimized, code security
...
```text
🔒 [CWE-78](https://cwe.mitre.org/data/definitions/78.html) OWASP:A05 CVSS:9.8 | OS Command Injection detected | CRITICAL [SOC2,PCI-DSS,ISO27001,NIST-CSF]
...
| **CWE Reference**               | ✅ [CWE-78](https://cwe.mitre.org/data/definitions/78.html) included   | ⚠️ Limited             | ⚠️ Limited         |
