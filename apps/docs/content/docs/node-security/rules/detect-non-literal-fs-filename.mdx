...
> **Keywords:** path traversal, [CWE-22](https://cwe.mitre.org/data/definitions/22.html), security, ESLint rule, file system, fs module, directory traversal, file access, auto-fix, LLM-optimized, code security
...
```text
🔒 [CWE-22](https://cwe.mitre.org/data/definitions/22.html) OWASP:A01 CVSS:7.5 | Path Traversal detected | HIGH [SOC2,PCI-DSS,HIPAA,ISO27001]
...
| **CWE Reference**            | ✅ [CWE-22](https://cwe.mitre.org/data/definitions/22.html) included             | ⚠️ Limited             | ⚠️ Limited         |
