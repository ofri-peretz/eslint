...
> **Keywords:** eval, code injection, [CWE-95](https://cwe.mitre.org/data/definitions/95.html), security, ESLint rule, remote code execution, RCE, arbitrary code execution, Function constructor, auto-fix, LLM-optimized, code security
...
| ------------------- | --- | ------------------------------------------------------------------- | ------------ | -------------------------- |
| Code Injection      | 95  | [A03:2021](https://owasp.org/Top10/A03_2021-Injection/)             | 9.8 Critical | Complete server compromise |
| Command Injection   | 78  | [A03:2021](https://owasp.org/Top10/A03_2021-Injection/)             | 9.8 Critical | System command execution   |
| Prototype Pollution | 915 | [A01:2021](https://owasp.org/Top10/A01_2021-Broken_Access_Control/) | 8.1 High     | Object manipulation        |
...
| **CWE Reference**            | ✅ [CWE-95](https://cwe.mitre.org/data/definitions/95.html) included | ⚠️ Limited             | ⚠️ Limited            |
