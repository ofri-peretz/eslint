...
> **Keywords:** buffer overread, [CWE-126](https://cwe.mitre.org/data/definitions/126.html), out-of-bounds, memory safety, security, Node.js
...
```
🔒 [CWE-126](https://cwe.mitre.org/data/definitions/126.html) OWASP:A06-Vulnerable CVSS:7.5 | Buffer Overread | HIGH [SOC2,PCI-DSS]
