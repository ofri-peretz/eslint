...
> **Keywords:** [CWE-287](https://cwe.mitre.org/data/definitions/287.html), authentication, SCRAM-SHA-256, MongoDB, security
...
| Aspect            | Details                                 |
| ----------------- | --------------------------------------- |
| **CWE Reference** | [CWE-287](https://cwe.mitre.org/data/definitions/287.html) (Improper Authentication)       |
| **OWASP**         | [A07:2021](https://owasp.org/Top10/A07_2021-Identification_and_Authentication_Failures/) - Identification/Auth Failures |
