...
> **Keywords:** [CWE-798](https://cwe.mitre.org/data/definitions/798.html), hardcoded credentials, MongoDB, connection string, secrets, security
...
| Aspect            | Details                                   |
| ----------------- | ----------------------------------------- |
| **CWE Reference** | [CWE-798](https://cwe.mitre.org/data/definitions/798.html) (Hardcoded Credentials)           |
