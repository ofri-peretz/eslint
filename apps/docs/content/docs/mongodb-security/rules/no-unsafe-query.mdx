...
> **Keywords:** NoSQL injection, [CWE-943](https://cwe.mitre.org/data/definitions/943.html), MongoDB, Mongoose, operator injection, query manipulation, security
...
| Aspect            | Details                                   |
| ----------------- | ----------------------------------------- |
| **CWE Reference** | [CWE-943](https://cwe.mitre.org/data/definitions/943.html) (NoSQL Injection)                 |
...
```
🔒 [CWE-943](https://cwe.mitre.org/data/definitions/943.html) OWASP:[A03:2021](https://owasp.org/Top10/A03_2021-Injection/)-Injection CVSS:9.8 | NoSQL injection via user input | CRITICAL
