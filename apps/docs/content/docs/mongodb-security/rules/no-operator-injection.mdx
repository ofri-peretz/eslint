...
description: "Detects MongoDB operator injection attacks where user input is passed directly as query values, allowing attackers to inject operators like $ne, $gt, $or to byp"
---

> **Keywords:** NoSQL injection, [CWE-943](https://cwe.mitre.org/data/definitions/943.html), MongoDB, $ne, $gt, $or, operator injection, security
