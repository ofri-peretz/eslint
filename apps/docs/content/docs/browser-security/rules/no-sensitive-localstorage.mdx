...
> **Keywords:** localStorage, sessionStorage, tokens, [CWE-922](https://cwe.mitre.org/data/definitions/922.html), security, XSS, sensitive data
...
| Aspect            | Details                                             |
| ----------------- | --------------------------------------------------- |
| **CWE Reference** | [CWE-922](https://cwe.mitre.org/data/definitions/922.html) (Insecure Storage of Sensitive Information) |
| **Severity**      | 🔴 High                                             |
