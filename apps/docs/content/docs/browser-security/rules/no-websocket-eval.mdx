---
title: browser-security/no-websocket-eval
...
```text
🔒 [CWE-95](https://cwe.mitre.org/data/definitions/95.html) OWASP:A05 CVSS:9.8 | Eval Injection detected | CRITICAL [SOC2,PCI-DSS,ISO27001]
