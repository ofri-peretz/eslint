---
title: browser-security/no-sensitive-cookie-js
...
```text
⚠️ [CWE-1004](https://cwe.mitre.org/data/definitions/1004.html) OWASP:A02 CVSS:5.3 | Sensitive Cookie Without HttpOnly detected | MEDIUM
...
| Category          | ID                                |
| ----------------- | --------------------------------- |
| OWASP Top 10 2021 | [A02:2021](https://owasp.org/Top10/A02_2021-Cryptographic_Failures/) - Cryptographic Failures |
