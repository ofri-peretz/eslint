---
title: no-eval
description: "CWE: [CWE-95](https://cwe.mitre.org/data/definitions/95.html)"
---

> **Keywords:** eval, code injection, [CWE-94](https://cwe.mitre.org/data/definitions/94.html), security, dynamic code execution, Function constructor
...
| Aspect            | Details                      |
| ----------------- | ---------------------------- |
| **CWE Reference** | [CWE-94](https://cwe.mitre.org/data/definitions/94.html) (Code Injection)      |
| **Severity**      | 🔴 Critical                  |
