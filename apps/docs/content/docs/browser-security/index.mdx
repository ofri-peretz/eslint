...
<Callout type="tip">
  **Not for server-side code** — For Node.js/Express security, see [express-security](/docs/express-security). For database security, see [mongodb-security](/docs/mongodb-security) or [pg](/docs/pg).
</Callout>
...
<Cards>
  <Card title="📚 Browse All Rules" description="View all rules with examples and configurations" href="/docs/browser-security/rules" />
</Cards>
