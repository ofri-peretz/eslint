...
description: Enforces a maximum cognitive complexity threshold with refactoring guidance. This rule is part of @eslint/eslint-plugin-quality and provides LLM-optimized error
category: quality
severity: medium
tags: ['quality', 'maintainability', 'complexity']
autofix: suggestions
