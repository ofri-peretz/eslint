...
description: Detects duplicate function implementations with DRY refactoring suggestions. This rule is part of @eslint/eslint-plugin-quality and provides LLM-optimized error
category: quality
severity: low
...
> **Keywords:** code duplication, DRY principle, [CWE-1104](https://cwe.mitre.org/data/definitions/1104.html), ESLint rule, duplicate code, refactoring, SonarQube, auto-fix, LLM-optimized, code quality
...
| Aspect            | Details                                        |
| ----------------- | ---------------------------------------------- |
| **CWE Reference** | [CWE-1104](https://cwe.mitre.org/data/definitions/1104.html) (Code Duplication)                    |
...
```text
⚠️ [CWE-1104](https://cwe.mitre.org/data/definitions/1104.html) OWASP:A03 CVSS:5.3 | Unmaintainable Third-Party Components detected | MEDIUM
...
| **CWE Reference**              | ✅ [CWE-1104](https://cwe.mitre.org/data/definitions/1104.html) included | ⚠️ Limited            | ❌ No                       |
