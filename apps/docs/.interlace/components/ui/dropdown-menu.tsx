...
// rendered outside a `Menu.Group` ancestor (error #31). Consumers that want
// a semantic group label should wrap items in `<DropdownMenuGroup>` and
// place the GroupLabel inside.
