...
// ambient modules to no-op components so we only render the hero's
// structural shell.
vi.mock('@interlace/ui/ambient/stars-background', () => ({
  StarsBackground: () => null,
  ShootingStars: () => null,
  Meteors: () => null,
}));
vi.mock('@interlace/ui/ambient/daylight-background', () => ({
