...
import { useCodecovRepo, useCodecovComponents } from '@/lib/api';
...
export function CoveragePage() {
  const { data: repo, isLoading: isLoadingRepo } = useCodecovRepo();
  const { data: components, isLoading: isLoadingComponents, error } = useCodecovComponents();
