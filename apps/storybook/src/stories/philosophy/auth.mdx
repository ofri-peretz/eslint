...
Cross-link to [DEEP_LINKING_PHILOSOPHY.md](?path=/docs/philosophy-navigation-routing-deep-linking--docs) §1
...
Cross-link to [FORM_PHILOSOPHY.md](?path=/docs/philosophy-content-patterns-form--docs) §3 and
[ERROR_PHILOSOPHY.md](?path=/docs/philosophy-interaction-states-error--docs) §2. Auth errors are the most
...
Cross-link to [A11Y_PHILOSOPHY.md](?path=/docs/philosophy-interaction-states-a11y--docs) §10. **No cognitive
