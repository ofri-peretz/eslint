...
<Meta title="Philosophy/Foundations/UX" />
...
[`CTA_PHILOSOPHY.md`](?path=/docs/philosophy-interaction-states-cta--docs).

For keyboard accessibility — skip links, focus-visible, Tab order,
Safari Full Keyboard Access — see
[`KEYBOARD_PHILOSOPHY.md`](?path=/docs/philosophy-interaction-states-keyboard--docs).
