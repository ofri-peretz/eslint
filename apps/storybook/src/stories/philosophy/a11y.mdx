...
- A single `<h1>` per page (cross-link to [SEO_PHILOSOPHY.md](?path=/docs/philosophy-navigation-routing-seo--docs)).
...
[MOTION_PHILOSOPHY.md](?path=/docs/philosophy-foundations-motion--docs).
...
Already covered in [FORM_PHILOSOPHY.md](?path=/docs/philosophy-content-patterns-form--docs) §9. Highlights:
