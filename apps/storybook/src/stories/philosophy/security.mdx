...
<Meta title="Philosophy/Trust/Security" />
...
A focused sub-philosophy of [UX_PHILOSOPHY.md](?path=/docs/philosophy-foundations-ux--docs) and
[INTEROP_PHILOSOPHY.md](?path=/docs/philosophy-reach-interop--docs), expanding the security
...
Cross-link to [A11Y_PHILOSOPHY.md](?path=/docs/philosophy-interaction-states-a11y--docs) §10 and
[AUTH_PHILOSOPHY.md](?path=/docs/philosophy-trust-auth--docs) §6. Bot defenses:
