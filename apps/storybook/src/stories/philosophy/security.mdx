...
A focused sub-philosophy of [UX_PHILOSOPHY.md](?path=/docs/philosophy-ux--docs) and
[INTEROP_PHILOSOPHY.md](?path=/docs/philosophy-interop--docs), expanding the security
...
Cross-link to [A11Y_PHILOSOPHY.md](?path=/docs/philosophy-a11y--docs) §10 and
[AUTH_PHILOSOPHY.md](?path=/docs/philosophy-auth--docs) §6. Bot defenses:
