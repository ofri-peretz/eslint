...
<Meta title="Philosophy/Interaction & States/Keyboard" />

{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: KEYBOARD_PHILOSOPHY.md
    hash: b146550fb7b0 */}
...
This document is the sibling of [`UX_PHILOSOPHY.md`](?path=/docs/philosophy-foundations-ux--docs),
[`CTA_PHILOSOPHY.md`](?path=/docs/philosophy-interaction-states-cta--docs), and
[`MOTION_PHILOSOPHY.md`](?path=/docs/philosophy-foundations-motion--docs) — principles ordered by
...
- [`UX_PHILOSOPHY.md`](?path=/docs/philosophy-foundations-ux--docs) #1 (Adoption is friction
  subtraction) — keyboard nav IS friction subtraction for power users
  and accessibility users.
- [`UX_PHILOSOPHY.md`](?path=/docs/philosophy-foundations-ux--docs) #6 (Ease of use is performance)
  — keyboard responsiveness IS performance for non-mouse users.
- [`CTA_PHILOSOPHY.md`](?path=/docs/philosophy-interaction-states-cta--docs) #6 (Touch target ≥ 44×44) —
  applies to keyboard focus targets too.
- [`CTA_PHILOSOPHY.md`](?path=/docs/philosophy-interaction-states-cta--docs) #10 (State is part of the
