...
<Meta title="Philosophy/Observability/Utm" />
...
A focused sub-philosophy of [URL_PHILOSOPHY.md](?path=/docs/philosophy-navigation-routing-url--docs)
(principle #5 "default values never appear in URLs" and principle #9 "sticky
parameters survive navigation") and
[ANALYTICS_PHILOSOPHY.md](?path=/docs/philosophy-observability-analytics--docs), covering how `utm_*`
