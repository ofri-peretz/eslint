...
A focused sub-philosophy of [URL_PHILOSOPHY.md](?path=/docs/philosophy-url--docs)
(principle #5 "default values never appear in URLs" and principle #9 "sticky
parameters survive navigation") and
[ANALYTICS_PHILOSOPHY.md](?path=/docs/philosophy-analytics--docs), covering how `utm_*`
