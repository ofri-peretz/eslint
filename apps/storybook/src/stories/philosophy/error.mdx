...
<Meta title="Philosophy/Interaction & States/Error" />
...
Pairs with [LOADING_PHILOSOPHY.md](?path=/docs/philosophy-interaction-states-loading--docs): loading,
...
**Mechanics:** see [LOADING_PHILOSOPHY.md](?path=/docs/philosophy-interaction-states-loading--docs) for the
skeleton contract.
...
**Cross-link:** [LAYOUT_PHILOSOPHY.md](?path=/docs/philosophy-foundations-layout--docs) §6 *Reserve
