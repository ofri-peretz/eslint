...
<Meta title="Philosophy/Reach/Interop" />

{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: INTEROP_PHILOSOPHY.md
    hash: ce8af5468cbe */}

# Tooling Interop & Static-Analysis Philosophy

A standalone engineering philosophy. Where [DOCS_PHILOSOPHY.md](?path=/docs/philosophy-documentation-docs--docs)
governs what a rule looks like to a reader, and [URL_PHILOSOPHY.md](?path=/docs/philosophy-navigation-routing-url--docs)
