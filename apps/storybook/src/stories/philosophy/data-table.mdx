...
<Meta title="Philosophy/Content Patterns/Data Table" />

{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: DATA_TABLE_PHILOSOPHY.md
    hash: 42e7b7741029 */}

# Data Table Philosophy

A focused sub-philosophy of [UX_PHILOSOPHY.md](?path=/docs/philosophy-foundations-ux--docs), expanding
...
Pairs with [PAGINATION_PHILOSOPHY.md](?path=/docs/philosophy-content-patterns-pagination--docs) (we already
codified URL-state pagination) and [LOADING_PHILOSOPHY.md](?path=/docs/philosophy-interaction-states-loading--docs)
...
query string per [DEEP_LINKING_PHILOSOPHY.md](?path=/docs/philosophy-navigation-routing-deep-linking--docs).
...
Cross-link to [PAGINATION_PHILOSOPHY.md](?path=/docs/philosophy-content-patterns-pagination--docs). Tables
...
Cross-link to [LOADING_PHILOSOPHY.md](?path=/docs/philosophy-interaction-states-loading--docs) and
[ERROR_PHILOSOPHY.md](?path=/docs/philosophy-interaction-states-error--docs).
...
Cross-link to [A11Y_PHILOSOPHY.md](?path=/docs/philosophy-interaction-states-a11y--docs).
