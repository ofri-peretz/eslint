...
<Meta title="Philosophy/Navigation & Routing/Deep Linking" />
...
A focused sub-philosophy of [URL_PHILOSOPHY.md](?path=/docs/philosophy-navigation-routing-url--docs) and
[UX_PHILOSOPHY.md](?path=/docs/philosophy-foundations-ux--docs), expanding principle #2 ("Every URL is a
