...
> **Generated, do not hand-edit.** These files are produced by [`../../scripts/generate-oxlint-shims.mjs`](../../scripts/generate-oxlint-shims.mjs) and regenerated whenever a new plugin is added. To update one, regenerate; to add a new shim, add the source plugin and re-run the generator.
...
The [`../../scripts/verify-oxlint-shims.mjs`](../../scripts/verify-oxlint-shims.mjs) script is a CI gate that fails when shims drift from the source plugins. Run via the [`oxlint-parity.yml`](../../.github/workflows/oxlint-parity.yml) workflow.
