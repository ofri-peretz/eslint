 ...
 * The docs page (`apps/docs/content/docs/getting-started/concepts/cwe-compatibility.mdx`) embeds
...
function renderCoverageMd(report) {
  ...
  lines.push('> Single source of truth for which CWEs the Interlace ESLint ecosystem covers. Embedded by [docs/cwe-compatibility](../apps/docs/content/docs/getting-started/concepts/cwe-compatibility.mdx).');
  lines.push('');
  lines.push('## Summary');
  lines.push('');
