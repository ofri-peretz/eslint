 ...
 *
 * Usage:
 *   tsx scripts/generate-rule-tests.ts <plugin-name> [rule-name]
 *   tsx scripts/generate-rule-tests.ts mongodb-security          # all rules
 *   tsx scripts/generate-rule-tests.ts mongodb-security no-unsafe-query  # single rule
 *   tsx scripts/generate-rule-tests.ts --all                     # entire fleet
 *
 ...
 *
 * Generated by: tsx scripts/generate-rule-tests.ts
...
if (args.length === 0 || args.includes('--help')) {
  console.log(`
Usage: tsx scripts/generate-rule-tests.ts <plugin-name> [rule-name]
       tsx scripts/generate-rule-tests.ts --all
...
Examples:
  tsx scripts/generate-rule-tests.ts mongodb-security
  tsx scripts/generate-rule-tests.ts secure-coding no-graphql-injection
  tsx scripts/generate-rule-tests.ts --all
`);
  process.exit(0);
}
