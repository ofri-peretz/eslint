 ...
 *     vs the previous Nx-produced `dist/packages/<pkg>/src/index.js`)
 *   - `dist/package.json`, `dist/README.md`, etc. at the dist root
 *
 * Replaces the `@nx/js:tsc` executor (compile + asset copy) with plain
 * tooling. Run from the package directory; intended to be invoked by
 * Turbo via the workspace's `build` task.
 */
