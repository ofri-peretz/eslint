...
The default floor is 15,552,000 seconds (180 days) — the minimum [hstspreload.org](https://hstspreload.org/) accepts.
...
| ------------------- | --------- | ---------- | ------------------------------------------------- |
| `minMaxAge`         | `number`  | `15552000` | Minimum accepted `max-age`, in seconds            |
