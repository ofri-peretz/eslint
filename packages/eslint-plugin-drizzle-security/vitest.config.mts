...
/**
 * Vitest configuration for eslint-plugin-drizzle-security package
 *
 * @description
 * Configures Vitest for testing Drizzle ESLint rules with the following setup:
