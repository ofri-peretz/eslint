...
> **Keywords:** decompression bomb, zip bomb, gunzip, zlib, maxOutputLength, DoS, CWE-409, security, ESLint rule, LLM-optimized
...
- [`no-zip-slip`](./no-zip-slip.md) — Detect archive extraction path traversal
- [`no-unsafe-buffer-alloc`](./no-unsafe-buffer-alloc.md) — Detect uninitialized buffer allocation
