...
| `reportUnresolvedUrls` | `boolean` | `false` | Report a URL argument that is a user-input-named identifier with no traceable request source. Restores the pre-inversion naming heuristic. |
