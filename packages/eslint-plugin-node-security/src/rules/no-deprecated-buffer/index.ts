...
export const noDeprecatedBuffer: TSESLint.RuleModule<MessageIds, []> =
    ...
    meta: {
      ...
      messages: {
        deprecatedBufferConstructor: formatLLMMessage({
          ...
          documentationLink:
            'https://nodejs.org/api/buffer.html#bufnew-buffersize',
        }),
