 ...
 */
export function isLoaderExpression(node: TSESTree.Node): boolean {
...
export function isModuleLoader(
  ...
  if (init.type !== AST_NODE_TYPES.CallExpression)
    return isLoaderExpression(init);
