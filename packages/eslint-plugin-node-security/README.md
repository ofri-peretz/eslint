...
| [no-weak-dh-parameters](https://eslint.interlace.tools/docs/security/plugin-node-security/rules/no-weak-dh-parameters?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-node-security) | CWE-326 | A02:2021 |  | Disallow Diffie-Hellman and ECDH parameters below a safe strength | 🟢 | 💼 |  |  |  |  |
