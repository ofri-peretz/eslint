...
describe('cognitive-complexity', () => {
  ...
  describe('Edge Cases - Uncovered Lines', () => {
    ...
    ruleTester.run(
      'line 114 - function expression without id',
      cognitiveComplexity,
      {
        valid: [],
        invalid: [
    ...
    ruleTester.run(
      'line 149-151 - for statement with all parts',
      cognitiveComplexity,
      {
        valid: [],
        invalid: [
    ...
    ruleTester.run(
      'line 175 - logical expression operators',
      cognitiveComplexity,
      {
        valid: [],
        invalid: [
    ...
    ruleTester.run(
      'line 248 - function without block body',
      cognitiveComplexity,
      {
        valid: [
          {
    ...
    ruleTester.run(
      'line 365 - suggestion index branches',
      cognitiveComplexity,
      {
        valid: [],
        invalid: [
