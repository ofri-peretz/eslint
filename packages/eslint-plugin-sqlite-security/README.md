<p align="center">
  <a href="https://eslint.interlace.tools/?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security" target="blank"><img src="https://eslint.interlace.tools/logos/interlace.svg" alt="Interlace" height="90" /></a>
  &nbsp;&nbsp;
  <a href="https://www.sqlite.org" target="_blank"><img src="https://eslint.interlace.tools/logos/sqlite.svg" alt="SQLite" height="90" /></a>
  &nbsp;&nbsp;
...
<p align="center">
  Security rules for better-sqlite3 / sqlite3 (SQL injection prevention in raw queries).
</p>
...
- To check out the [guide](https://eslint.interlace.tools/docs/security/plugin-sqlite-security?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security), visit [eslint.interlace.tools](https://eslint.interlace.tools/?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security). 📚
- 要查看中文 [指南](https://eslint.interlace.tools/docs/security/plugin-sqlite-security?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security), 请访问 [eslint.interlace.tools](https://eslint.interlace.tools/?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security). 📚
- [가이드](https://eslint.interlace.tools/docs/security/plugin-sqlite-security?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security) 문서는 [eslint.interlace.tools](https://eslint.interlace.tools/?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security)에서 확인하실 수 있습니다. 📚
- [ガイド](https://eslint.interlace.tools/docs/security/plugin-sqlite-security?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security)は [eslint.interlace.tools](https://eslint.interlace.tools/?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security)でご確認ください。 📚
- Para ver la [guía](https://eslint.interlace.tools/docs/security/plugin-sqlite-security?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security), visita [eslint.interlace.tools](https://eslint.interlace.tools/?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security). 📚
- للاطلاع على [الدليل](https://eslint.interlace.tools/docs/security/plugin-sqlite-security?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security)، قم بزيارة [eslint.interlace.tools](https://eslint.interlace.tools/?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security). 📚

```bash
npm install eslint-plugin-sqlite-security --save-dev
```
...
| ------- | --- | --------- | --------- |
| `better-sqlite3` | [![npm](https://img.shields.io/npm/v/better-sqlite3.svg?style=flat-square)](https://www.npmjs.com/package/better-sqlite3) | [![downloads](https://img.shields.io/npm/dt/better-sqlite3.svg?style=flat-square)](https://www.npmjs.com/package/better-sqlite3) | SQL Injection |
| `sqlite3` | [![npm](https://img.shields.io/npm/v/sqlite3.svg?style=flat-square)](https://www.npmjs.com/package/sqlite3) | [![downloads](https://img.shields.io/npm/dt/sqlite3.svg?style=flat-square)](https://www.npmjs.com/package/sqlite3) | SQL Injection |

### Custom Configuration

```javascript
import sqlite from 'eslint-plugin-sqlite-security';
...
## 💡 What You Get
- **Covers the escapes your ORM leaves open:** `.prepare()`, `.exec()`, `.run()`, `.all()`, `.get()`
- **SQLite's own remediation:** every finding names SQLite's own safe API, not a generic "use parameterized queries"
...
| :--- | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| [no-unsafe-query](https://eslint.interlace.tools/docs/security/plugin-sqlite-security/rules/no-unsafe-query?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security) | CWE-89 | A03:2021 |  | Prevent SQL injection by disallowing string concatenation or interpolated template literals in SQLite state… | 🟢 | 💼 |  |  |  |  |
...
<p align="center">
  <a href="https://eslint.interlace.tools/docs/security/plugin-sqlite-security?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security"><img src="https://eslint.interlace.tools/images/og-sqlite-security.png" alt="ESLint Interlace Plugin" width="100%" /></a>
</p>

<p align="center">
  <a href="https://eslint.interlace.tools/?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-sqlite-security" target="blank"><img src="https://eslint.interlace.tools/icon-light.svg" alt="Interlace" height="70" /></a>
</p>
