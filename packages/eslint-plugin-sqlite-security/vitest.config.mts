...
/**
 * Vitest configuration for eslint-plugin-sqlite-security package
 *
 * @description
 * Configures Vitest for testing SQLite ESLint rules with the following setup:
