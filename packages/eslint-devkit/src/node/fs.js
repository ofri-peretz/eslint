...
exports.findFileUpward = findFileUpward;
...
function findFileUpward(filename, startDir) {
    ...
    while (currentDir !== (0, path_1.getDirname)(currentDir)) {
        // Stop at root
        const candidate = (0, path_1.joinPath)(currentDir, filename);
        if (fileExistsSync(candidate)) {
            return candidate;
        }
        currentDir = (0, path_1.getDirname)(currentDir);
    }
    return null;
}
