...
- **🔒 Security** — `identifierWords` no longer backtracks quadratically (CWE-1333)
...
- **🐛 Fix** — **✨ New** — `eslint-plugin-supabase-security`, four rules for the Supabase client.
...
- **🐛 Fix** — a null cooked quasi no longer erases a credential URL
...
- **✨ Feature** — **✨ Feature** — `spellings`: the five ways a rule reads a name, in one place
