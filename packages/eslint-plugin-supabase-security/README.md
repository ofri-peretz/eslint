...
<p align="center">
  Security rules for <a href="https://www.npmjs.com/package/@supabase/supabase-js">@supabase/supabase-js</a> — the Supabase client.
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/eslint-plugin-supabase-security" target="_blank"><img src="https://img.shields.io/npm/v/eslint-plugin-supabase-security.svg" alt="NPM Version" /></a>
  <a href="https://www.npmjs.com/package/eslint-plugin-supabase-security" target="_blank"><img src="https://img.shields.io/npm/dm/eslint-plugin-supabase-security.svg" alt="NPM Downloads" /></a>
  <a href="https://packagephobia.com/result?p=eslint-plugin-supabase-security" target="_blank"><img src="https://badgen.net/packagephobia/install/eslint-plugin-supabase-security" alt="Install Size" /></a>
...
- To check out the [guide](https://eslint.interlace.tools/docs/security/plugin-supabase-security?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-supabase-security), visit [eslint.interlace.tools](https://eslint.interlace.tools/?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-supabase-security). 📚
...
| Package                 | Version                                                                                                                                 |
| :---------------------- | :-------------------------------------------------------------------------------------------------------------------------------------- |
| `@supabase/supabase-js` | [![npm](https://img.shields.io/npm/v/@supabase/supabase-js.svg?style=flat-square)](https://www.npmjs.com/package/@supabase/supabase-js) |
...
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----: | :------: | :--: | :---------------------------------------------------- | :-: | :-: | :-: | :-: | :-: | :-: |
| [no-dynamic-rpc-name](https://eslint.interlace.tools/docs/security/plugin-supabase-security/rules/no-dynamic-rpc-name?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-supabase-security)                     | CWE-913 | A03:2021 |      | Call `.rpc()` with a literal function name            | 🟢  |     |     |     |     |     |
| [no-public-storage-bucket](https://eslint.interlace.tools/docs/security/plugin-supabase-security/rules/no-public-storage-bucket?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-supabase-security)           | CWE-732 | A01:2021 |      | Do not create a Supabase storage bucket as public     | 🟢  |     |     |     |     |     |
| [no-service-role-key-in-client](https://eslint.interlace.tools/docs/security/plugin-supabase-security/rules/no-service-role-key-in-client?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-supabase-security) | CWE-798 | A02:2021 |      | Keep the Supabase service_role key out of client code | 🟢  |     |     |     |     |     |
| [require-auth-error-check](https://eslint.interlace.tools/docs/security/plugin-supabase-security/rules/require-auth-error-check?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-supabase-security)           | CWE-287 | A07:2021 |      | Read `error` from a Supabase auth result              | 🟢  |     |     |     |     |     |
...
<p align="center">
  <a href="https://eslint.interlace.tools/docs/security/plugin-supabase-security?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-supabase-security"><img src="https://eslint.interlace.tools/images/og-supabase-security.png" alt="ESLint Interlace Plugin" width="100%" /></a>
</p>
