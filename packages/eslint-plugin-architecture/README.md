...
|  Rule                         | General |  General  |  General  |  General  |  General  |  General      |    General    |  General  |    CWE     |                 OWASP                  |  CVSS  |  Description  |  💼   |  ⚠️   |  🔧   |  💡   |  🚫   |
|  `enforce-naming`             | General |  General  |  General  |  General  |  General  |  General      |    General    |  General  |  CWE-1078  |       Enforce naming conventions       |   💼   |
|  `ddd-anemic-domain-model`    | General |  General  |  General  |  General  |  General  |  General      |    General    |  General  |  CWE-1061  |      Prevent anemic domain models      |   ⚠️   |  💡           |
|  `enforce-module-boundaries`  | General |  General  |  General  |  General  |  General  |  General      |    General    |  General  |  CWE-1047  |         Enforce API boundaries         |   💼   |
|  `no-circular-module-deps`    | General |  General  |  General  |  General  |  General  |  General      |    General    |  General  |  CWE-407   |  Prevent circular module dependencies  |   💼   |  💡           |
