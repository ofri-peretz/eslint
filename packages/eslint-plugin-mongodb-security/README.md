...
| Preset        | Description                                                      |
| :------------ | :--------------------------------------------------------------- |
| `recommended` | Core security rules to prevent common injection attacks.         |
| `strict`      | Enforces stricter query validation and disables risky operators. |
...
<p align="center">
  <a href="https://eslint.interlace.tools/docs/mongodb-security"><img src="https://eslint.interlace.tools/images/og-mongodb-security.png" alt="ESLint Interlace Plugin" width="100%" /></a>
</p>