...
> Context for AI coding agents working on eslint-plugin-postgresql-security
...
# Build this package
nx build eslint-plugin-postgresql-security

# Run tests
nx test eslint-plugin-postgresql-security

# Run tests with coverage
nx test eslint-plugin-postgresql-security --coverage

# Lint this package
nx lint eslint-plugin-postgresql-security
```
...
- Run specific rule test: `nx test eslint-plugin-postgresql-security --testPathPattern="no-unsafe-query"`
