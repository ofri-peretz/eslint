...
async function runBenchmark() {
  console.log('\n');
  log('╔═══════════════════════════════════════════════════════════════════════════╗', colors.cyan);
  log('║     eslint-plugin-postgresql-security BENCHMARK                                            ║', colors.cyan);
  ...
  log('   Running eslint-plugin-postgresql-security...', colors.reset);
  const vulnResults = runESLint('eslint.config.pg.mjs', TEST_FILE, ITERATIONS);
  
  console.log(`
   ┌─────────────────────────────┬──────────────────────┐
   │ Metric                      │ eslint-plugin-postgresql-security     │
   ├─────────────────────────────┼──────────────────────┤
