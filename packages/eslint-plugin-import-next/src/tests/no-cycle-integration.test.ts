...
describe('no-cycle - Integration Tests', () => {
  let tempDir: string;
  ...
  describe('Basic Circular Dependency Detection', () => {
    it('should detect simple circular dependency between two files', () => {
      ...
      ruleTester.run('simple circular dependency', noCycle, {
        valid: [],
        invalid: [
          {
    ...
    it('should detect three-file circular dependency', () => {
      ...
      ruleTester.run('three-file circular dependency', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
  ...
  describe('Path Resolution', () => {
    it('should resolve imports with .ts extension', () => {
      ...
      ruleTester.run('resolve .ts extension', noCycle, {
        valid: [
          {
    ...
    it('should resolve imports with index files', () => {
      ...
      ruleTester.run('resolve index files', noCycle, {
        valid: [
          {
            code: fs.readFileSync(indexFile, 'utf-8'),
            filename: indexFile,
    ...
    it('should resolve alias imports with @app prefix', () => {
      ...
      ruleTester.run('resolve @app alias', noCycle, {
        valid: [
          {
            code: fs.readFileSync(indexFile, 'utf-8'),
            filename: indexFile,
    ...
    it('should resolve alias imports with @src prefix', () => {
      ...
      ruleTester.run('resolve @src alias', noCycle, {
        valid: [
          {
            code: fs.readFileSync(indexFile, 'utf-8'),
            filename: indexFile,
    ...
    it('should resolve alias imports with index files', () => {
      ...
      ruleTester.run('resolve alias with index', noCycle, {
        valid: [
          {
            code: fs.readFileSync(indexFile, 'utf-8'),
            filename: indexFile,
  ...
  describe('File Reading and Import Detection', () => {
    it('should read file and detect ES6 imports', () => {
      ...
      ruleTester.run('detect ES6 imports', noCycle, {
        valid: [
          {
            code: fs.readFileSync(indexFile, 'utf-8'),
            filename: indexFile,
    ...
    it('should detect default imports', () => {
      ...
      ruleTester.run('detect default imports', noCycle, {
        valid: [
          {
            code: fs.readFileSync(indexFile, 'utf-8'),
            filename: indexFile,
    ...
    it('should detect namespace imports', () => {
      ...
      ruleTester.run('detect namespace imports', noCycle, {
        valid: [
          {
            code: fs.readFileSync(indexFile, 'utf-8'),
            filename: indexFile,
    ...
    it('should detect dynamic imports', () => {
      ...
      ruleTester.run('detect dynamic imports', noCycle, {
        valid: [
          {
            code: fs.readFileSync(indexFile, 'utf-8'),
            filename: indexFile,
    ...
    it('should handle non-existent files gracefully', () => {
      ...
      ruleTester.run('handle non-existent files', noCycle, {
        valid: [
          {
            code: fs.readFileSync(indexFile, 'utf-8'),
            filename: indexFile,
  ...
  describe('Cycle Detection Logic', () => {
    it('should respect maxDepth option', () => {
      ...
      ruleTester.run('respect maxDepth', noCycle, {
        valid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
            filename: fileA,
    ...
    it('should track visited files to avoid infinite loops', () => {
      ...
      ruleTester.run('track visited files', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
    ...
    it('should skip dynamic imports in cycle detection', () => {
      ...
      ruleTester.run('skip dynamic imports', noCycle, {
        valid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
            filename: fileA,
  ...
  describe('Type-Only Imports', () => {
    it('should detect type-only imports', () => {
      ...
      ruleTester.run('detect type-only imports', noCycle, {
        valid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
            filename: fileA,
    ...
    it('should detect runtime imports in type-only cycle', () => {
      ...
      ruleTester.run('detect runtime imports', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
  ...
  describe('Fix Strategy Selection', () => {
    it('should use module-split strategy', () => {
      ...
      ruleTester.run('module-split strategy', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
    ...
    it('should use direct-import strategy', () => {
      ...
      ruleTester.run('direct-import strategy', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
    ...
    it('should use extract-shared strategy', () => {
      ...
      ruleTester.run('extract-shared strategy', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
    ...
    it('should use dependency-injection strategy', () => {
      ...
      ruleTester.run('dependency-injection strategy', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
    ...
    it('should auto-detect strategy with barrel export', () => {
      ...
      ruleTester.run('auto-detect with barrel', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
    ...
    it('should auto-detect strategy with types only', () => {
      ...
      ruleTester.run('auto-detect with types', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
  ...
  describe('Barrel Export Detection', () => {
    it('should detect barrel exports', () => {
      ...
      ruleTester.run('detect barrel exports', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
  ...
  describe('Ignore Patterns', () => {
    it('should ignore files matching ignore patterns', () => {
      ...
      ruleTester.run('ignore test files', noCycle, {
        valid: [
          {
  ...
  describe('Cycle Hash and Deduplication', () => {
    ...
    it('should extract minimal cycle from longer path', () => {
      ...
      ruleTester.run('extract minimal cycle', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
  ...
  describe('Message Generation', () => {
    it('should generate module split message with semantic naming', () => {
      ...
      ruleTester.run('module split semantic', noCycle, {
        valid: [],
        invalid: [
          {
            code: fs.readFileSync(fileA, 'utf-8'),
  ...
  describe('Edge Cases', () => {
    it('should handle file read errors gracefully', () => {
      ...
      ruleTester.run('handle file read errors', noCycle, {
        valid: [
          {
            code: fs.readFileSync(indexFile, 'utf-8'),
            filename: indexFile,
    ...
    it('should handle files not in cycle', () => {
      ...
      ruleTester.run('handle files not in cycle', noCycle, {
        valid: [
          {
