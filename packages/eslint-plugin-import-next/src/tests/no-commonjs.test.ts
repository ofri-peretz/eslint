          ...
          errors: [
            {
              ...
              suggestions: [
                {
                  messageId: 'commonjsRequire',
                  output: `const helper = // Convert to: import * as moduleName from './helper';\nrequire("./helper");`,
                },
              ],
            },
          ],
          ...
          errors: [
            {
              ...
              suggestions: [
                {
                  messageId: 'commonjsRequire',
                  output: `const { Component } = // Convert to: import * as moduleName from 'react';\nrequire("react");`,
                },
              ],
            },
          ],
          ...
          errors: [
            {
              ...
              suggestions: [
                {
                  messageId: 'commonjsRequire',
                  output: `const utils = // Convert to: import * as moduleName from './utils';\nrequire("./utils");`,
                },
              ],
            },
          ],
              ...
              suggestions: [
                {
                  messageId: 'commonjsExport',
                  output:
                    '// Convert to: export default helper;\nmodule.exports = helper;',
                },
              ],
            },
          ],
              ...
              suggestions: [
                {
                  messageId: 'commonjsModule',
                  output:
                    '// Convert to: export const propertyName = value;\nmodule.exports.helper = function() {};',
                },
              ],
            },
          ],
              ...
              suggestions: [
                {
                  messageId: 'commonjsModule',
                  output:
                    '// Convert to: export const Component = class {};\nexports.Component = class {};',
                },
              ],
            },
          ],
              ...
              suggestions: [
                {
                  messageId: 'commonjsModule',
                  output:
                    '// Convert to: export const helper = function() {};\nexports.helper = function() {};',
                },
              ],
            },
          ],
