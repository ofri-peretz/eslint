  ...
  meta: {
    ...
    messages: {
      ...
      multipleNamedToDefault: formatLLMMessage({
        ...
        description:
          'Consider consolidating related exports into default export',
        severity: 'LOW',
    ...
    schema: [
      {
        ...
        properties: {
          target: {
            ...
            default: 'single',
            description:
              'When to enforce default exports: always (all), single (single export), as-needed (when beneficial)',
          },
          ignoreFiles: {
            type: 'array',
            items: { type: 'string' },
      ...
      if (
        ...
        context.report({
          ...
          data: {
            ...
            benefit:
              'Default exports provide cleaner import syntax and better tree-shaking',
          },
          suggest: [
            {
              messageId: 'preferDefaultExport',
      ...
      ExportNamedDeclaration(node: TSESTree.ExportNamedDeclaration) {
        ...
        if (node.source && node.specifiers) {
          ...
          if (hasDefaultReExport) {
            ...
            defaultExportNode =
              node as unknown as TSESTree.ExportDefaultDeclaration;
          }
        ...
        if (
          ...
          context.report({
            ...
            data: {
              ...
              suggestion:
                'Consider grouping related exports as a default export object',
            },
          });
        } else {
          checkSingleExport();
