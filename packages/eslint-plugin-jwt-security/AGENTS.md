...
> Context for AI coding agents working on eslint-plugin-jwt-security
...
# Build this package
nx build eslint-plugin-jwt-security

# Run tests
nx test eslint-plugin-jwt-security

# Run tests with coverage
nx test eslint-plugin-jwt-security --coverage

# Lint this package
nx lint eslint-plugin-jwt-security
```
...
- Run specific rule test: `nx test eslint-plugin-jwt-security --testPathPattern="no-algorithm-none"`
