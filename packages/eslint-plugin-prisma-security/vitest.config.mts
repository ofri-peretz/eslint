...
/**
 * Vitest configuration for eslint-plugin-prisma-security package
 *
 * @description
 * Configures Vitest for testing Prisma ESLint rules with the following setup:
