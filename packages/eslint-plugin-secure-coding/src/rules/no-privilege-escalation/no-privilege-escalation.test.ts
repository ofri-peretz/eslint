...
describe('regression locks', () => {
  ruleTester.run('lock: a role guard clause silences the rule', noPrivilegeEscalation, {
    valid: [
  ...
  ruleTester.run('lock: privilege verbs match whole names or phrases', noPrivilegeEscalation, {
    valid: [
  ...
  ruleTester.run('lock: privilege vocabulary excludes level and bare input', noPrivilegeEscalation, {
    valid: [
  ...
  ruleTester.run('lock: bracket notation and one binding hop', noPrivilegeEscalation, {
    valid: [
...
ruleTester.run('coverage - computed keys and braceless guards', noPrivilegeEscalation, {
  valid: [
