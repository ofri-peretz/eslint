...
> Require validation of deep link URLs

**Severity:** 🟠 HIGH  
**CWE:** [CWE-939](https://cwe.mitre.org/data/definitions/939.html)  
**OWASP Mobile:** [OWASP Mobile Top 10 M4](https://owasp.org/www-project-mobile-top-10/)

## Rule Details

This rule detects security violations related to Require validation of deep link URLs.
