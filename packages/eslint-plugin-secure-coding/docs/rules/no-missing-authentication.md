...
| `ignorePatterns` | `string[]` | `["login","logout","signin","sign-in","signup","sign-up","register","forgot-password","reset-password","password-reset","verify-email","health","healthz","readyz","livez","status","metrics","ping","favicon","webhook","/public/","oauth","callback"]` | Route paths that are public by definition and need no authentication. Replaces the built-in list; supplying it also widens matching from the route path to the whole registration text. |
