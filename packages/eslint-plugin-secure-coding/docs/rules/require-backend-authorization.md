...
**OWASP Mobile:** [OWASP Mobile Top 10 M3](https://owasp.org/www-project-mobile-top-10/)

## Rule Details

This rule detects security violations related to Require server-side authorization checks.
