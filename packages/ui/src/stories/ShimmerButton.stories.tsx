...
import { ShimmerButton } from '../magicui/shimmer-button.js';
...
// ---------------------------------------------------------------------------
// Display stories — visual variants. No `play` function: these document the
// component's surface area for designers and reviewers.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Interactivity tests — `play` functions exercised by the Storybook
// test-runner. Each one also runs in CI via `npm run test-storybook`.
// ---------------------------------------------------------------------------
