...
<div align="center">
  <img src="https://eslint.interlace.tools/images/og-pg.png" alt="ESLint Interlace - eslint-plugin-pg" width="200" />
</div>
...
| :--- | :--- | :---: | :---: | :---: | :--- | :-: | :-: | :-: | :-: | :-: |
|  [no-unsafe-query](./docs/rules/no-unsafe-query.md)  | Security |  CWE-89  |  A03:2021  |  Prevents SQL injection via string interpolation  |  💼  |  💡  |
|  [no-insecure-ssl](./docs/rules/no-insecure-ssl.md)  | Security |  CWE-295  |  A05:2021  |  Prevents disabling SSL certificate validation  |  💼  |  💡  |
|  [no-hardcoded-credentials](./docs/rules/no-hardcoded-credentials.md)  | Security |  CWE-798  |  A05:2021  |  Prevents hardcoded passwords in config  |  💼  |  💡  |
|  [no-unsafe-search-path](./docs/rules/no-unsafe-search-path.md)  | Security |  CWE-426  |  A01:2021  |  Prevents dynamic search_path hijacking  |  💼  |  💡  |
|  [no-unsafe-copy-from](./docs/rules/no-unsafe-copy-from.md)  | Security |  CWE-22  |  A03:2021  |  Prevents COPY FROM file path exposure  |  💼  |  💡  |
|  [no-transaction-on-pool](./docs/rules/no-transaction-on-pool.md)  | Security |  CWE-362  |  A04:2021  |  Prevents transaction commands on pool  |  💼  |  💡  |
|  [no-missing-client-release](./docs/rules/no-missing-client-release.md)  | Resource Management |  CWE-772  |  A09:2021  |  Ensures pool clients are released  |  💼  |  💡  |
|  [prevent-double-release](./docs/rules/prevent-double-release.md)  | Resource Management |  CWE-415  |  A04:2021  |  Prevents double client.release()  |  💼  |  💡  |
|  [no-floating-query](./docs/rules/no-floating-query.md)  | Resource Management |  CWE-252  |  A06:2021  |  Ensures query promises are handled  |  💼  |  💡  |
|  [check-query-params](./docs/rules/check-query-params.md)  | Quality & Performance |  CWE-20  |  A06:2021  |  Validates parameter count matches placeholders  |  💼  |  💡  |
|  [no-select-all](./docs/rules/no-select-all.md)  | Quality & Performance |  CWE-400  |  A04:2021  |  Discourages SELECT \*  |  💡  |
|  [prefer-pool-query](./docs/rules/prefer-pool-query.md)  | Quality & Performance |  CWE-404  |  A04:2021  |  Suggests pool.query() for simple queries  |  💡  |
|  [no-batch-insert-loop](./docs/rules/no-batch-insert-loop.md)  | Quality & Performance |  CWE-400  |  A04:2021  |  Prevents N+1 mutation queries  |  💼  |  💡  |
