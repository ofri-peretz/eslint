...
/**
 * no-hardcoded-credentials — mysql2 / mysql CWE-798.
 *
...
export const noHardcodedCredentials = createHardcodedCredentialsRule({
  meta: {
    ...
    docs: {
      ...
      url: 'https://github.com/ofri-peretz/eslint/blob/main/packages/eslint-plugin-mysql-security/docs/rules/no-hardcoded-credentials.md',
      cwe: 'CWE-798',
      cvss: 9.8,
      confidence: 'high',
    },
