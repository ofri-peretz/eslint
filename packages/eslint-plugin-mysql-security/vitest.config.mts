...
/**
 * Vitest configuration for eslint-plugin-mysql-security package
 *
 * @description
 * Configures Vitest for testing MySQL ESLint rules with the following setup:
