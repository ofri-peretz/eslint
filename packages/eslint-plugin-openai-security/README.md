...
| :--- | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| [no-browser-api-key-exposure](https://eslint.interlace.tools/docs/security/plugin-openai-security/rules/no-browser-api-key-exposure?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-openai-security) | CWE-522 | A07:2021 |  | Forbid dangerouslyAllowBrowser, which exposes the OpenAI API key to the client | 🟢 |  |  |  |  |  |
| [no-hardcoded-api-key](https://eslint.interlace.tools/docs/security/plugin-openai-security/rules/no-hardcoded-api-key?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-openai-security) | CWE-798 | A07:2021 |  | Forbid a literal API key in the OpenAI client options | 🟢 |  |  |  |  |  |
| [no-untrusted-content-in-prompt](https://eslint.interlace.tools/docs/security/plugin-openai-security/rules/no-untrusted-content-in-prompt?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-openai-security) | CWE-1427 | A03:2021 |  | Disallow untrusted content built into the OpenAI system prompt | 🟢 |  |  |  |  |  |
...
<p align="center">
  <a href="https://eslint.interlace.tools/?utm_source=github&utm_medium=referral&utm_campaign=eslint-plugin-openai-security" target="blank"><img src="https://eslint.interlace.tools/logos/interlace.svg" alt="Interlace" height="70" /></a>
</p>
