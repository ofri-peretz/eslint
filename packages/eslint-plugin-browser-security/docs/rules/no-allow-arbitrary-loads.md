...
| ------ | ---- | ------- | ----------- |
| `insecureLoadKeys` | `string[]` | `["NSAllowsArbitraryLoads","NSAllowsArbitraryLoadsInWebContent","NSAllowsArbitraryLoadsForMedia","NSAllowsLocalNetworking","NSExceptionAllowsInsecureHTTPLoads","NSThirdPartyExceptionAllowsInsecureHTTPLoads"]` | Configuration keys that disable transport security; replaces the Apple ATS vocabulary |
