...
/**
 * no-hardcoded-credentials — TypeORM CWE-798.
 *
...
export const noHardcodedCredentials = createHardcodedCredentialsRule({
  meta: {
    ...
    docs: {
      description:
        'Disallow literal database passwords in TypeORM DataSource configuration, including credentials embedded in a connection URL.',
      url: 'https://github.com/ofri-peretz/eslint/blob/main/packages/eslint-plugin-typeorm-security/docs/rules/no-hardcoded-credentials.md',
      cwe: 'CWE-798',
      cvss: 9.8,
      confidence: 'high',
    },
